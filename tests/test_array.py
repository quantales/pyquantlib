...
class TestArrayConstructors:
    ...
    def test_size_value_constructor(self):
        arr = ql.Array(3, 7.5)
        assert len(arr) == 3
        for i in range(3):
            assert arr[i] == 7.5
...
class TestArrayBufferProtocol:

    def test_to_numpy_view(self):
...
class TestArraySizeAndCapacity:

    def test_size_len_empty(self):
        arr = ql.Array([1, 2, 3])
        assert arr.size() == 3
        assert len(arr) == 3
...
class TestArrayOperators:
    ...
    def test_inplace_operators_array(self):
        arr1 = ql.Array([1, 2, 3])
        arr2 = ql.Array([4, 5, 6])
    ...
    def test_inplace_operators_scalar(self):
        arr = ql.Array([1, 2, 3])
    ...
    def test_binary_operators_array(self):
        arr1 = ql.Array([1, 2, 3])
        arr2 = ql.Array([4, 5, 6])
    ...
    def test_binary_operators_scalar(self):
        arr = ql.Array([1, 2, 3])
