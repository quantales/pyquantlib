...
void ql_pricingengines::fdhestonrebateengine(py::module_& m) {
    py::class_<FdHestonRebateEngine, PricingEngine,
               ext::shared_ptr<FdHestonRebateEngine>>(
        m, "FdHestonRebateEngine",
