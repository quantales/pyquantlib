...
DECLARE_MODULE_BINDINGS(pricingengines_bindings) {
    ...
    ADD_MAIN_BINDING(ql_pricingengines::mceuropeangjrgarchengine,
        "MCEuropeanGJRGARCHEngine - MC GJR-GARCH European pricing");
    ...
    ADD_MAIN_BINDING(ql_pricingengines::analyticdoublebarrierbinaryengine,
        "AnalyticDoubleBarrierBinaryEngine - one-touch double barrier binary option");
    ADD_MAIN_BINDING(ql_pricingengines::fdblackscholesbarrierengine,
        "FdBlackScholesBarrierEngine - FD barrier option engine");
    ADD_MAIN_BINDING(ql_pricingengines::fdblackscholesrebateengine,
        "FdBlackScholesRebateEngine - FD barrier option rebate engine");
    ADD_MAIN_BINDING(ql_pricingengines::mcbarrierengine,
