...
void ql_pricingengines::mcforwardeuropeanbsengine(py::module_& m) {
    m.def("MCForwardEuropeanBSEngine",
        [](const ext::shared_ptr<GeneralizedBlackScholesProcess>& process,
           ...
           BigNatural seed) -> ext::shared_ptr<PricingEngine> {
            ...
            if (lowerRngType == "pseudorandom") {
                auto maker = MakeMCForwardEuropeanBSEngine<PseudoRandom>(process);
                ...
                auto maker = MakeMCForwardEuropeanBSEngine<LowDiscrepancy>(process);
