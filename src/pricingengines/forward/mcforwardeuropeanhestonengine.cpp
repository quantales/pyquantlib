...
void ql_pricingengines::mcforwardeuropeanhestonengine(py::module_& m) {
    m.def("MCForwardEuropeanHestonEngine",
        [](const ext::shared_ptr<HestonProcess>& process,
           ...
           BigNatural seed,
           bool controlVariate) -> ext::shared_ptr<PricingEngine> {
            ...
            if (lowerRngType == "pseudorandom") {
                auto maker = MakeMCForwardEuropeanHestonEngine<PseudoRandom>(process);
                ...
                auto maker = MakeMCForwardEuropeanHestonEngine<LowDiscrepancy>(process);
