...
void ql_pricingengines::turnbullwakemanasianengine(py::module_& m) {
    py::class_<TurnbullWakemanAsianEngine, PricingEngine,
               ext::shared_ptr<TurnbullWakemanAsianEngine>>(
        m, "TurnbullWakemanAsianEngine",
