...
void ql_termstructures::interpolatedzeroinflationcurve(py::module_& m) {
    using Curve = ZeroInflationCurve;  // InterpolatedZeroInflationCurve<Linear>

    py::class_<Curve, ZeroInflationTermStructure, ext::shared_ptr<Curve>>(
        m, "ZeroInflationCurve",
