...
void ql_termstructures::piecewiseyoyinflationcurve(py::module_& m) {
    using Curve = PiecewiseYoYInflationCurve<Linear>;
    ...
    py::class_<Curve, YoYInflationTermStructure, ext::shared_ptr<Curve>>(
        ...
        .def(py::init([](const Date& referenceDate,
            ...
            return ext::make_shared<Curve>(
                referenceDate, baseDate, baseYoYRate, frequency,
                dayCounter, instruments, s, accuracy);
        }),
