...
void ql_methods::hundsdorferscheme(py::module_& m) {
    using bc_set = HundsdorferScheme::bc_set;
    py::class_<HundsdorferScheme>(m, "HundsdorferScheme",
        ...
        .def("step", [](HundsdorferScheme& self, Array a, Time t) {
            self.step(a, t);
            return a;
        }, py::arg("a"), py::arg("t"),
            "Applies one time step and returns the modified array.")
        .def("setStep", &HundsdorferScheme::setStep,
            py::arg("dt"),
