...
void ql_methods::craigsneydscheme(py::module_& m) {
    using bc_set = CraigSneydScheme::bc_set;
    py::class_<CraigSneydScheme>(m, "CraigSneydScheme",
        ...
        .def("step", [](CraigSneydScheme& self, Array a, Time t) {
            self.step(a, t);
            return a;
        }, py::arg("a"), py::arg("t"),
            "Applies one time step and returns the modified array.")
        .def("setStep", &CraigSneydScheme::setStep,
            py::arg("dt"),
