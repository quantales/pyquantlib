...
class AUCPI(ZeroInflationIndex):
    ...
    """
    @typing.overload
    def __init__(self, frequency: Frequency, revised: bool) -> None:
        """
        Constructs AUCPI without a term structure.
        """
    @typing.overload
    def __init__(self, frequency: Frequency, revised: bool, h: ...) -> None:
        """
        Constructs AUCPI with a term structure handle.
        """
    @typing.overload
    def __init__(self, frequency: Frequency, revised: bool, zeroInflationTermStructure: ...) -> None:
        """
...
class AdaptiveRungeKutta:
    ...
    """
    def __call__(self, ode: collections.abc.Callable[[typing.SupportsFloat | typing.SupportsIndex, collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex]], list[float]], y1: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], x1: typing.SupportsFloat | typing.SupportsIndex, x2: typing.SupportsFloat | typing.SupportsIndex) -> list[float]:
        """
        Integrates N-dimensional ODE from x1 to x2 with initial condition y(x1) = y1.
        """
    def __init__(self, eps: typing.SupportsFloat | typing.SupportsIndex = 1e-06, h1: typing.SupportsFloat | typing.SupportsIndex = 0.0001, hmin: typing.SupportsFloat | typing.SupportsIndex = 0.0) -> None:
        """
        Constructs with prescribed error *eps*, initial step *h1*, and minimum step *hmin*.
        """
    def solve1d(self, ode: collections.abc.Callable[[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], float], y1: typing.SupportsFloat | typing.SupportsIndex, x1: typing.SupportsFloat | typing.SupportsIndex, x2: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
...
class AmericanExercise(Exercise):
    ...
    """
    def __init__(self, earliestDate: Date, latestDate: Date, payoffAtExpiry: bool = False) -> None:
        """
...
class AmortizingPayment(SimpleCashFlow):
    ...
    def __init__(self, amount: typing.SupportsFloat | typing.SupportsIndex, date: Date) -> None:
        ...
        """
class AnalyticAmericanMargrabeEngine(base.PricingEngine):
    """
...
class AnalyticBarrierEngine(base.PricingEngine):
    ...
    def __init__(self, process: GeneralizedBlackScholesProcess) -> None:
        ...
        """
class AnalyticBinaryBarrierEngine(base.PricingEngine):
    """
...
class AnalyticBlackVasicekEngine(base.PricingEngine):
    ...
    def __init__(self, bsProcess: GeneralizedBlackScholesProcess, vasicekProcess: Vasicek, correlation: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
        """
class AnalyticCEVEngine(base.PricingEngine):
    """
    Analytic Constant Elasticity of Variance pricing engine.
    """
    @typing.overload
    def __init__(self, f0: typing.SupportsFloat | typing.SupportsIndex, alpha: typing.SupportsFloat | typing.SupportsIndex, beta: typing.SupportsFloat | typing.SupportsIndex, discountCurve: YieldTermStructureHandle) -> None:
        """
        Constructs AnalyticCEVEngine.
        """
    @typing.overload
    def __init__(self, f0: typing.SupportsFloat | typing.SupportsIndex, alpha: typing.SupportsFloat | typing.SupportsIndex, beta: typing.SupportsFloat | typing.SupportsIndex, discountCurve: base.YieldTermStructure) -> None:
        """
        Constructs from yield term structure (handle created internally).
        """
class AnalyticCapFloorEngine(base.PricingEngine):
    """
    Analytic cap/floor engine for affine short-rate models.
    """
    @typing.overload
    def __init__(self, model: base.AffineModel, termStructure: YieldTermStructureHandle = ...) -> None:
        """
        Constructs analytic cap/floor engine.
        """
    @typing.overload
    def __init__(self, model: base.AffineModel, termStructure: base.YieldTermStructure) -> None:
        """
        Constructs analytic cap/floor engine (handle created internally).
        """
class AnalyticCliquetEngine(base.PricingEngine):
    """
    Analytic engine for cliquet options.
    """
    def __init__(self, process: GeneralizedBlackScholesProcess) -> None:
        ...
class AnalyticComplexChooserEngine(base.PricingEngine):
    """
    Analytic engine for complex chooser options.
    """
    def __init__(self, process: GeneralizedBlackScholesProcess) -> None:
        ...
class AnalyticCompoundOptionEngine(base.PricingEngine):
    """
    Analytic engine for compound options (option on an option).
    """
    def __init__(self, process: GeneralizedBlackScholesProcess) -> None:
        ...
class AnalyticContinuousFixedLookbackEngine(base.PricingEngine):
    """
    Analytic engine for continuous fixed-strike lookback options.
    """
    def __init__(self, process: GeneralizedBlackScholesProcess) -> None:
        ...
class AnalyticContinuousFloatingLookbackEngine(base.PricingEngine):
    """
...
class AnalyticContinuousGeometricAveragePriceAsianEngine(base.PricingEngine):
    ...
    def __init__(self, process: GeneralizedBlackScholesProcess) -> None:
        ...
        Constructs engine.
        """
class AnalyticContinuousPartialFixedLookbackEngine(base.PricingEngine):
    """
    Analytic engine for continuous partial fixed-strike lookback options.
    """
    def __init__(self, process: GeneralizedBlackScholesProcess) -> None:
        ...
class AnalyticContinuousPartialFloatingLookbackEngine(base.PricingEngine):
    """
    Analytic engine for continuous partial floating-strike lookback options.
    """
    def __init__(self, process: GeneralizedBlackScholesProcess) -> None:
        ...
class AnalyticDigitalAmericanEngine(base.PricingEngine):
    """
...
class AnalyticDiscreteGeometricAveragePriceAsianEngine(base.PricingEngine):
    ...
    def __init__(self, process: GeneralizedBlackScholesProcess) -> None:
        ...
        Constructs engine.
        """
class AnalyticDiscreteGeometricAverageStrikeAsianEngine(base.PricingEngine):
    """
    ...
    def __init__(self, process: GeneralizedBlackScholesProcess) -> None:
        ...
        Constructs engine.
        """
class AnalyticDividendEuropeanEngine(base.PricingEngine):
    """
    European engine with discrete dividends.
    """
    def __init__(self, process: GeneralizedBlackScholesProcess, dividends: collections.abc.Sequence[base.Dividend]) -> None:
        """
        Constructs analytic dividend European engine.
        """
class AnalyticDoubleBarrierBinaryEngine(base.PricingEngine):
    """
...
class AnalyticEuropeanEngine(base.OneAssetOption.engine):
    ...
    def __init__(self, process: GeneralizedBlackScholesProcess, discountCurve: base.YieldTermStructure) -> None:
        ...
        """
class AnalyticEuropeanMargrabeEngine(base.PricingEngine):
    """
...
class AnalyticHestonHullWhiteEngine(AnalyticHestonEngine):
    ...
    def __init__(self, hestonModel: HestonModel, hullWhiteModel: HullWhite, relTolerance: typing.SupportsFloat | typing.SupportsIndex, maxEvaluations: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
        Constructs with adaptive Gauss-Lobatto integration.
        """
class AnalyticHolderExtensibleOptionEngine(base.PricingEngine):
    """
    Analytic holder-extensible option engine.
    """
    def __init__(self, process: GeneralizedBlackScholesProcess) -> None:
        ...
class AnalyticPDFHestonEngine(base.PricingEngine):
    """
    ...
    def cdf(self, X: typing.SupportsFloat | typing.SupportsIndex, t: typing.SupportsFloat | typing.SupportsIndex) -> float:
        ...
        """
class AnalyticPTDHestonEngine(base.PricingEngine):
    """
    ...
    def numberOfEvaluations(self) -> int:
        ...
        Returns number of integration evaluations.
        """
class AnalyticPartialTimeBarrierOptionEngine(base.PricingEngine):
    """
    ...
    def __init__(self, process: GeneralizedBlackScholesProcess) -> None:
        ...
        Constructs engine.
        """
class AnalyticSimpleChooserEngine(base.PricingEngine):
    """
    Analytic engine for simple chooser options.
    """
    def __init__(self, process: GeneralizedBlackScholesProcess) -> None:
        ...
class AnalyticSoftBarrierEngine(base.PricingEngine):
    """
    ...
    def __init__(self, process: GeneralizedBlackScholesProcess) -> None:
        ...
        Constructs engine.
        """
class AnalyticTwoAssetBarrierEngine(base.PricingEngine):
    """
    Analytic two-asset barrier option engine.
    """
    @typing.overload
    def __init__(self, process1: GeneralizedBlackScholesProcess, process2: GeneralizedBlackScholesProcess, rho: QuoteHandle) -> None:
        """
        Constructs engine with two processes and correlation.
        """
    @typing.overload
    def __init__(self, process1: GeneralizedBlackScholesProcess, process2: GeneralizedBlackScholesProcess, rho: base.Quote) -> None:
        """
        Constructs engine (handle created internally).
        """
class AnalyticTwoAssetCorrelationEngine(base.PricingEngine):
    """
    Analytic two-asset correlation option engine.
    """
    @typing.overload
    def __init__(self, p1: GeneralizedBlackScholesProcess, p2: GeneralizedBlackScholesProcess, correlation: QuoteHandle) -> None:
        ...
    @typing.overload
    def __init__(self, p1: GeneralizedBlackScholesProcess, p2: GeneralizedBlackScholesProcess, correlation: base.Quote) -> None:
        """
        Constructs from shared_ptr correlation (handle created internally).
        """
class AnalyticWriterExtensibleOptionEngine(base.PricingEngine):
    """
...
class AndreasenHugeVolatilityAdapter(base.BlackVolTermStructure):
    ...
    """
    def __init__(self, volInterpl: AndreasenHugeVolatilityInterpl, eps: typing.SupportsFloat | typing.SupportsIndex = 1e-06) -> None:
        """
        Constructs from an AndreasenHugeVolatilityInterpl instance.
        """
class AndreasenHugeVolatilityInterpl:
    ...
    def calibrationError(self) -> tuple[float, float, float]:
        ...
        """
    def fwd(self, t: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        Returns the forward price at time t.
        """
    def localVol(self, t: typing.SupportsFloat | typing.SupportsIndex, strike: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
    ...
    def minStrike(self) -> float:
        ...
    def optionPrice(self, t: typing.SupportsFloat | typing.SupportsIndex, strike: typing.SupportsFloat | typing.SupportsIndex, optionType: OptionType) -> float:
        """
...
class AverageBMALeg:
    ...
    def __init__(self, schedule: Schedule, index: ...) -> None:
        ...
        """
    def leg(self) -> list[base.CashFlow]:
        """
    ...
    def withNotionals(self, notionals: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex]) -> AverageBMALeg:
        ...
        """
    def withPaymentAdjustment(self, convention: BusinessDayConvention) -> AverageBMALeg:
        """
        Sets payment business day convention.
        """
    def withPaymentDayCounter(self, dayCounter: DayCounter) -> AverageBMALeg:
        """
...
class BEFCurrency(Currency):
    ...
    def __init__(self) -> None:
        ...
class BFGS(base.OptimizationMethod):
    """
...
class BHDCurrency(Currency):
    ...
    def __init__(self) -> None:
        ...
class BMAIndex(base.InterestRateIndex):
    """
    ...
    def __init__(self, curve: ...) -> None:
        ...
        """
    def fixingSchedule(self, start: Date, end: Date) -> Schedule:
        """
...
class BRLCurrency(Currency):
    ...
    def __init__(self) -> None:
        ...
class BSMRNDCalculator(base.RiskNeutralDensityCalculator):
    """
...
class BachelierYoYInflationCouponPricer(YoYInflationCouponPricer):
    ...
    def __init__(self) -> None:
        ...
        """
    @typing.overload
    def __init__(self, nominalTermStructure: ...) -> None:
        """
        Constructs with a nominal term structure.
        """
    @typing.overload
    def __init__(self, capletVol: ..., nominalTermStructure: ...) -> None:
        """
...
class BatesProcessHandle:
    ...
    def __bool__(self) -> bool:
        ...
        """
    def __eq__(self, arg0: BatesProcessHandle) -> bool:
        ...
    @typing.overload
    def __init__(self) -> None:
        """
    ...
    def __init__(self, ptr: typing.Any, registerAsObserver: bool = True) -> None:
        ...
        """
    def __lt__(self, arg0: BatesProcessHandle) -> bool:
        ...
    def __ne__(self, arg0: BatesProcessHandle) -> bool:
        ...
    def asObservable(self) -> Observable:
        """
        Converts to Observable for observer registration.
        """
    def currentLink(self) -> BatesProcess:
        """
...
class BespokeCalendar(Calendar):
    ...
    def addWeekend(self, param_0: Weekday) -> None:
        ...
        """
class BicubicSpline(base.Interpolation2D):
    """
    ...
    def secondDerivativeY(self, x: typing.SupportsFloat | typing.SupportsIndex, y: typing.SupportsFloat | typing.SupportsIndex) -> float:
        ...
        """
class BilinearInterpolation(base.Interpolation2D):
    """
...
class BlackAveragingOvernightIndexedCouponPricer(ArithmeticAveragedOvernightIndexedCouponPricer):
    ...
    def __init__(self) -> None:
        ...
        """
    @typing.overload
    def __init__(self, v: ..., effectiveVolatilityInput: bool = False) -> None:
        """
...
class BlackCallableFixedRateBondEngine(base.PricingEngine):
    ...
    """
    @typing.overload
    def __init__(self, fwdYieldVol: QuoteHandle, discountCurve: YieldTermStructureHandle) -> None:
        """
        Constructs with forward yield volatility quote and discount curve.
        """
    @typing.overload
    def __init__(self, yieldVolStructure: ..., discountCurve: YieldTermStructureHandle) -> None:
        """
        Constructs with callable bond volatility structure and discount curve.
        """
    @typing.overload
    def __init__(self, fwdYieldVol: base.Quote, discountCurve: base.YieldTermStructure) -> None:
        """
        Constructs with quote and term structure (handles created internally).
        """
    @typing.overload
    def __init__(self, yieldVolStructure: base.CallableBondVolatilityStructure, discountCurve: base.YieldTermStructure) -> None:
        """
...
class BlackCapFloorEngine(base.PricingEngine):
    ...
    def __init__(self, discountCurve: base.YieldTermStructure, vol: base.Quote, dayCounter: DayCounter = ..., displacement: typing.SupportsFloat | typing.SupportsIndex = 0.0) -> None:
        ...
        """
class BlackCdsOptionEngine(base.PricingEngine):
    """
    ...
    def __init__(self, defaultProbTS: base.DefaultProbabilityTermStructure, recoveryRate: typing.SupportsFloat | typing.SupportsIndex, termStructure: base.YieldTermStructure, vol: base.Quote) -> None:
        ...
        """
    def termStructure(self) -> YieldTermStructureHandle:
        """
        Returns the term structure handle.
        """
    def volatility(self) -> QuoteHandle:
        """
...
class Bond(base.Instrument):
    ...
    def startDate(self) -> Date:
        ...
        """
class BondForward(base.Forward):
    """
...
class BoundaryConditionSide:
    ...
    Members:
      ...
      Lower
    """
    Lower: typing.ClassVar[BoundaryConditionSide]  # value = <BoundaryConditionSide.Lower: 2>
    None_: typing.ClassVar[BoundaryConditionSide]  # value = <BoundaryConditionSide.None_: 0>
    Upper: typing.ClassVar[BoundaryConditionSide]  # value = <BoundaryConditionSide.Upper: 1>
    __members__: typing.ClassVar[dict[str, BoundaryConditionSide]]  # value = {'None_': <BoundaryConditionSide.None_: 0>, 'Upper': <BoundaryConditionSide.Upper: 1>, 'Lower': <BoundaryConditionSide.Lower: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class BoxMullerGaussianRng:
    ...
    """
    @typing.overload
    def __init__(self, uniformGenerator: MersenneTwisterUniformRng) -> None:
        """
...
class BrownianBridge:
    ...
    def __init__(self, steps: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
        """
    @typing.overload
    def __init__(self, timeGrid: TimeGrid) -> None:
        """
    ...
    def __repr__(self) -> str:
        ...
    def bridgeIndex(self) -> list[int]:
        """
        Bridge construction indices.
        """
    def leftIndex(self) -> list[int]:
        """
...
class Burley2020SobolBrownianBridgeRsg:
    ...
    def nextSequence(self) -> ...:
        ...
        """
class Burley2020SobolBrownianGenerator(base.BrownianGenerator):
    """
    ...
    def __init__(self, factors: typing.SupportsInt | typing.SupportsIndex, steps: typing.SupportsInt | typing.SupportsIndex, ordering: Ordering, seed: typing.SupportsInt | typing.SupportsIndex = 42, directionIntegers: SobolRsg.DirectionIntegers = ..., scrambleSeed: typing.SupportsInt | typing.SupportsIndex = 43) -> None:
        ...
        """
class Burley2020SobolBrownianGeneratorFactory(base.BrownianGeneratorFactory):
    """
...
class CEVCalculator:
    ...
    def f0(self) -> float:
        ...
        """
    def value(self, optionType: OptionType, strike: typing.SupportsFloat | typing.SupportsIndex, t: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        Returns CEV option value.
        """
class CEVRNDCalculator(base.RiskNeutralDensityCalculator):
    """
...
class COPCurrency(Currency):
    ...
    def __init__(self) -> None:
        ...
class COSHestonEngine(base.PricingEngine):
    """
...
class CalibrationErrorType:
    ...
    def value(self) -> int:
        ...
class Callability(base.Event):
    """
    Instrument callability (call or put) at a given date.
    """
    def __init__(self, price: BondPrice, type: CallabilityType, date: Date) -> None:
        """
...
class CallabilityType:
    ...
    Members:
      ...
      Put
    """
    Call: typing.ClassVar[CallabilityType]  # value = <CallabilityType.Call: 0>
    Put: typing.ClassVar[CallabilityType]  # value = <CallabilityType.Put: 1>
    __members__: typing.ClassVar[dict[str, CallabilityType]]  # value = {'Call': <CallabilityType.Call: 0>, 'Put': <CallabilityType.Put: 1>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
    ...
    def value(self) -> int:
        ...
class CallableBondConstantVolatility(base.CallableBondVolatilityStructure):
    """
    ...
    def __init__(self, settlementDays: typing.SupportsInt | typing.SupportsIndex, calendar: Calendar, volatility: base.Quote, dayCounter: DayCounter) -> None:
        ...
        """
class CallableFixedRateBond(base.CallableBond):
    """
    ...
    def __init__(self, settlementDays: typing.SupportsInt | typing.SupportsIndex, faceAmount: typing.SupportsFloat | typing.SupportsIndex, schedule: Schedule, coupons: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], accrualDayCounter: DayCounter, paymentConvention: BusinessDayConvention = ..., redemption: typing.SupportsFloat | typing.SupportsIndex = 100.0, issueDate: Date = ..., putCallSchedule: collections.abc.Sequence[Callability] = []) -> None:
        ...
        """
class CallableZeroCouponBond(base.CallableBond):
    """
...
class CappedFlooredYoYInflationCoupon(YoYInflationCoupon):
    ...
    """
    @typing.overload
    def __init__(self, underlying: YoYInflationCoupon, cap: typing.Any = None, floor: typing.Any = None) -> None:
        """
    ...
    def isFloored(self) -> bool:
        ...
        """
class CashDividendEuropeanEngine(base.PricingEngine):
    """
    Semi-analytic European engine with cash dividends (Healy, 2021).
    """
    def __init__(self, process: GeneralizedBlackScholesProcess, dividends: collections.abc.Sequence[base.Dividend], cashDividendModel: CashDividendModel = ...) -> None:
        """
...
class CashOrNothingPayoff(base.StrikedTypePayoff):
    ...
    def cashPayoff(self) -> float:
        ...
        """
class CdsOption(base.Option):
    """
    Option on a credit default swap.
    """
    def __init__(self, swap: CreditDefaultSwap, exercise: Exercise, knocksOut: bool = True) -> None:
        """
    ...
    def riskyAnnuity(self) -> float:
        ...
        """
    def underlyingSwap(self) -> CreditDefaultSwap:
        """
...
class ChebyshevInterpolation(base.Interpolation):
    ...
    def __init__(self, n: typing.SupportsInt | typing.SupportsIndex, f: collections.abc.Callable[[typing.SupportsFloat | typing.SupportsIndex], float], pointsType: ChebyshevPointsType = ...) -> None:
        ...
        """
    @typing.overload
    def __init__(self, y: Array, pointsType: ChebyshevPointsType = ...) -> None:
        """
    ...
    def nodes(self) -> Array:
        ...
        """
    def updateY(self, y: Array) -> None:
        """
        Updates the y values.
        """
class ChebyshevPointsType:
    """
    Chebyshev node type.
    ...
    Members:
      ...
      SecondKind
    """
    FirstKind: typing.ClassVar[ChebyshevPointsType]  # value = <ChebyshevPointsType.FirstKind: 0>
    SecondKind: typing.ClassVar[ChebyshevPointsType]  # value = <ChebyshevPointsType.SecondKind: 1>
    __members__: typing.ClassVar[dict[str, ChebyshevPointsType]]  # value = {'FirstKind': <ChebyshevPointsType.FirstKind: 0>, 'SecondKind': <ChebyshevPointsType.SecondKind: 1>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class China(Calendar):
    ...
    def __init__(self, m: China.Market = ...) -> None:
        ...
class ChoiAsianEngine(base.PricingEngine):
    """
    Choi (2018) discrete arithmetic Asian option engine.
    """
    def __init__(self, process: GeneralizedBlackScholesProcess, lambda: typing.SupportsFloat | typing.SupportsIndex = 15.0, maxNrIntegrationSteps: typing.SupportsInt | typing.SupportsIndex = 4194304) -> None:
        """
        Constructs engine.
        """
class ChoiBasketEngine(base.PricingEngine):
    """
    Choi (2018) N-dimensional basket option engine.
    """
    def __init__(self, processes: collections.abc.Sequence[GeneralizedBlackScholesProcess], rho: Matrix, lambda: typing.SupportsFloat | typing.SupportsIndex = 10.0, maxNrIntegrationSteps: typing.SupportsInt | typing.SupportsIndex = 18446744073709551615, calcfwdDelta: bool = False, controlVariate: bool = False) -> None:
        """
        Constructs engine.
        """
class CliquetOption(base.OneAssetOption):
    """
    Cliquet (ratchet) option with periodic resets.
    """
    def __init__(self, payoff: PercentageStrikePayoff, maturity: EuropeanExercise, resetDates: collections.abc.Sequence[Date]) -> None:
        ...
...
class Collar(CapFloor):
    ...
    def __init__(self, floatingLeg: collections.abc.Sequence[base.CashFlow], capRates: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], floorRates: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex]) -> None:
        ...
        Constructs a collar.
        """
class ComplexChooserOption(base.OneAssetOption):
    """
...
class CompositeQuote(base.Quote):
    ...
    def __init__(self, quote1: QuoteHandle, quote2: QuoteHandle, function: collections.abc.Callable) -> None:
        ...
        """
class CompositeZeroYieldStructure(base.YieldTermStructure):
    """
    Composite zero-yield term structure from two curves and a binary function.
    """
    @typing.overload
    def __init__(self, curve1: YieldTermStructureHandle, curve2: YieldTermStructureHandle, composer: collections.abc.Callable[[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], float], compounding: Compounding = ..., frequency: Frequency = ...) -> None:
        """
        Constructs from yield curve handles and a composer function.
        """
    @typing.overload
    def __init__(self, curve1: base.YieldTermStructure, curve2: base.YieldTermStructure, composer: collections.abc.Callable[[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex], float], compounding: Compounding = ..., frequency: Frequency = ...) -> None:
        """
        Constructs from yield curves and composer (handles created internally).
        """
class CompoundOption(base.OneAssetOption):
    """
    Option on an option (compound option).
    """
    def __init__(self, motherPayoff: base.StrikedTypePayoff, motherExercise: Exercise, daughterPayoff: base.StrikedTypePayoff, daughterExercise: Exercise) -> None:
        ...
class Compounding:
    """
...
class Concentrating1dMesher(Fdm1dMesher):
    ...
    def __init__(self, start: typing.SupportsFloat | typing.SupportsIndex, end: typing.SupportsFloat | typing.SupportsIndex, size: typing.SupportsInt | typing.SupportsIndex, cPoints: collections.abc.Sequence[tuple[typing.SupportsFloat | typing.SupportsIndex, typing.SupportsFloat | typing.SupportsIndex, bool]], tol: typing.SupportsFloat | typing.SupportsIndex = 1e-08) -> None:
        ...
        """
class ConjugateGradient(base.OptimizationMethod):
    """
...
class ConstantSwaptionVolatility(base.SwaptionVolatilityStructure):
    ...
    def volatilityType(self) -> VolatilityType:
        ...
        """
class ConstantYoYOptionletVolatility(base.YoYOptionletVolatilitySurface):
    """
    ...
    def __init__(self, volatility: base.Quote, settlementDays: typing.SupportsInt | typing.SupportsIndex, calendar: Calendar, bdc: BusinessDayConvention, dayCounter: DayCounter, observationLag: Period, frequency: Frequency, indexIsInterpolated: bool, minStrike: typing.SupportsFloat | typing.SupportsIndex = -1.0, maxStrike: typing.SupportsFloat | typing.SupportsIndex = 100.0, volatilityType: VolatilityType = ..., displacement: typing.SupportsFloat | typing.SupportsIndex = 0.0) -> None:
        ...
        """
class ContinuousArithmeticAsianLevyEngine(base.PricingEngine):
    """
    Levy (1992) continuous arithmetic Asian engine.
    """
    @typing.overload
    def __init__(self, process: GeneralizedBlackScholesProcess, currentAverage: QuoteHandle) -> None:
        """
        Constructs engine with process and current running average.
        """
    @typing.overload
    def __init__(self, process: GeneralizedBlackScholesProcess, currentAverage: base.Quote) -> None:
        """
        Constructs engine (handle created internally).
        """
class ContinuousAveragingAsianOption(base.OneAssetOption):
    ...
    def __init__(self, averageType: AverageType, payoff: base.StrikedTypePayoff, exercise: Exercise) -> None:
        ...
        """
    @typing.overload
    def __init__(self, averageType: AverageType, startDate: Date, payoff: base.StrikedTypePayoff, exercise: Exercise) -> None:
        """
        Constructs a seasoned ContinuousAveragingAsianOption with start date.
        """
class ContinuousFixedLookbackOption(base.OneAssetOption):
    """
...
class ContinuousPartialFixedLookbackOption(ContinuousFixedLookbackOption):
    ...
    """
    def __init__(self, lookbackPeriodStart: Date, payoff: base.StrikedTypePayoff, exercise: Exercise) -> None:
        ...
...
class ConvertibleZeroCouponBond(ConvertibleBond):
    ...
    def __init__(self, exercise: Exercise, conversionRatio: typing.SupportsFloat | typing.SupportsIndex, callability: collections.abc.Sequence[Callability], issueDate: Date, settlementDays: typing.SupportsInt | typing.SupportsIndex, dayCounter: DayCounter, schedule: Schedule, redemption: typing.SupportsFloat | typing.SupportsIndex = 100.0) -> None:
        ...
        """
class CoxIngersollRoss(base.OneFactorAffineModel):
    """
...
class DEConfiguration:
    ...
    def __init__(self) -> None:
        ...
        """
    def withAdaptiveCrossover(self, b: bool = True) -> DEConfiguration:
        """
        Sets whether crossover is adaptive.
        """
    def withBounds(self, b: bool = True) -> DEConfiguration:
        """
    ...
    def withCrossoverProbability(self, p: typing.SupportsFloat | typing.SupportsIndex) -> DEConfiguration:
        ...
        """
    def withCrossoverType(self, crossoverType: DECrossoverType) -> DEConfiguration:
        """
        Sets crossover type.
        """
    def withLowerBound(self, l: Array) -> DEConfiguration:
        """
        Sets lower bounds.
        """
    ...
    def withStepsizeWeight(self, w: typing.SupportsFloat | typing.SupportsIndex) -> DEConfiguration:
        ...
        """
    def withStrategy(self, strategy: DEStrategy) -> DEConfiguration:
        """
        Sets mutation strategy.
        """
    def withUpperBound(self, u: Array) -> DEConfiguration:
        """
        Sets upper bounds.
        """
    @property
    def applyBounds(self) -> bool:
        """
        Whether to apply bounds.
        """
    @applyBounds.setter
    def applyBounds(self, arg0: bool) -> None:
        ...
    @property
    def crossoverIsAdaptive(self) -> bool:
        """
        Whether crossover is adaptive.
        """
    @crossoverIsAdaptive.setter
    def crossoverIsAdaptive(self, arg0: bool) -> None:
        ...
    @property
    ...
    def crossoverType(self) -> DECrossoverType:
        ...
        Crossover type.
        """
    @crossoverType.setter
    def crossoverType(self, arg0: DECrossoverType) -> None:
        ...
    @property
    def lowerBound(self) -> Array:
        """
        Lower bounds for parameters.
        """
    @lowerBound.setter
    def lowerBound(self, arg0: Array) -> None:
        ...
    @property
    def populationMembers(self) -> int:
        """
    ...
    def strategy(self) -> DEStrategy:
        ...
        """
    @strategy.setter
    def strategy(self, arg0: DEStrategy) -> None:
        ...
    @property
    def upperBound(self) -> Array:
        """
        Upper bounds for parameters.
        """
    @upperBound.setter
    def upperBound(self, arg0: Array) -> None:
        ...
class DECrossoverType:
    """
    ...
    Members:
      ...
      Exponential
    """
    Binomial: typing.ClassVar[DECrossoverType]  # value = <DECrossoverType.Binomial: 1>
    Exponential: typing.ClassVar[DECrossoverType]  # value = <DECrossoverType.Exponential: 2>
    Normal: typing.ClassVar[DECrossoverType]  # value = <DECrossoverType.Normal: 0>
    __members__: typing.ClassVar[dict[str, DECrossoverType]]  # value = {'Normal': <DECrossoverType.Normal: 0>, 'Binomial': <DECrossoverType.Binomial: 1>, 'Exponential': <DECrossoverType.Exponential: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class DEStrategy:
    ...
    """
    BestMemberWithJitter: typing.ClassVar[DEStrategy]  # value = <DEStrategy.BestMemberWithJitter: 1>
    CurrentToBest2Diffs: typing.ClassVar[DEStrategy]  # value = <DEStrategy.CurrentToBest2Diffs: 2>
    EitherOrWithOptimalRecombination: typing.ClassVar[DEStrategy]  # value = <DEStrategy.EitherOrWithOptimalRecombination: 5>
    Rand1DiffWithDither: typing.ClassVar[DEStrategy]  # value = <DEStrategy.Rand1DiffWithDither: 4>
    Rand1DiffWithPerVectorDither: typing.ClassVar[DEStrategy]  # value = <DEStrategy.Rand1DiffWithPerVectorDither: 3>
    Rand1SelfadaptiveWithRotation: typing.ClassVar[DEStrategy]  # value = <DEStrategy.Rand1SelfadaptiveWithRotation: 6>
    Rand1Standard: typing.ClassVar[DEStrategy]  # value = <DEStrategy.Rand1Standard: 0>
    __members__: typing.ClassVar[dict[str, DEStrategy]]  # value = {'Rand1Standard': <DEStrategy.Rand1Standard: 0>, 'BestMemberWithJitter': <DEStrategy.BestMemberWithJitter: 1>, 'CurrentToBest2Diffs': <DEStrategy.CurrentToBest2Diffs: 2>, 'Rand1DiffWithPerVectorDither': <DEStrategy.Rand1DiffWithPerVectorDither: 3>, 'Rand1DiffWithDither': <DEStrategy.Rand1DiffWithDither: 4>, 'EitherOrWithOptimalRecombination': <DEStrategy.EitherOrWithOptimalRecombination: 5>, 'Rand1SelfadaptiveWithRotation': <DEStrategy.Rand1SelfadaptiveWithRotation: 6>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class DerivedQuote(base.Quote):
    ...
    def __init__(self, quote: QuoteHandle, function: collections.abc.Callable) -> None:
        ...
        """
class DifferentialEvolution(base.OptimizationMethod):
    """
    Differential evolution global optimization method.
    """
    def __init__(self, configuration: DEConfiguration = ...) -> None:
        """
...
class EquityIndex(base.Index):
    ...
    def __init__(self, name: str, fixingCalendar: Calendar, currency: Currency) -> None:
        ...
        """
    @typing.overload
    def __init__(self, name: str, fixingCalendar: Calendar, currency: Currency, interest: ..., dividend: ..., spot: QuoteHandle) -> None:
        """
        Constructs an equity index with term structure handles.
        """
    @typing.overload
    def __init__(self, name: str, fixingCalendar: Calendar, currency: Currency, interest: ..., dividend: ..., spot: base.Quote) -> None:
        """
        Constructs an equity index (handles created internally).
        """
    def clone(self, interest: ..., dividend: ..., spot: QuoteHandle) -> EquityIndex:
        """
...
class EquityTotalReturnSwap(Swap):
    ...
    def equityIndex(self) -> EquityIndex:
        ...
        """
    def equityLeg(self) -> list[base.CashFlow]:
        """
    ...
    def gearing(self) -> float:
        ...
        """
    def interestRateIndex(self) -> base.InterestRateIndex:
        """
        Returns the interest rate index.
        """
    def interestRateLeg(self) -> list[base.CashFlow]:
        """
...
class Exercise:
    ...
    def lastDate(self) -> Date:
        ...
        """
class ExpSinhIntegral(base.Integrator):
    """
...
class ExplicitEulerScheme:
    ...
    """
    def __init__(self, map: FdmLinearOpComposite, bcSet: collections.abc.Sequence[FdmBoundaryCondition] = []) -> None:
        """
    ...
    def step(self, a: Array, t: typing.SupportsFloat | typing.SupportsIndex) -> Array:
        ...
        Applies one time step and returns the modified array.
        """
class ExponentialFittingHestonEngine(base.PricingEngine):
    """
...
class ExponentialJump1dMesher(Fdm1dMesher):
    ...
    """
    def __init__(self, steps: typing.SupportsInt | typing.SupportsIndex, beta: typing.SupportsFloat | typing.SupportsIndex, jumpIntensity: typing.SupportsFloat | typing.SupportsIndex, eta: typing.SupportsFloat | typing.SupportsIndex, eps: typing.SupportsFloat | typing.SupportsIndex = 0.001) -> None:
        """
        Constructs with step count and jump parameters.
        """
    @typing.overload
    def jumpSizeDensity(self, x: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        Asymptotic jump size density (t -> infinity).
        """
    @typing.overload
    def jumpSizeDensity(self, x: typing.SupportsFloat | typing.SupportsIndex, t: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        Time-dependent jump size density.
        """
    @typing.overload
    def jumpSizeDistribution(self, x: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        Asymptotic jump size distribution.
        """
    @typing.overload
    def jumpSizeDistribution(self, x: typing.SupportsFloat | typing.SupportsIndex, t: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
...
class ExponentialSplinesFitting(base.FittingMethod):
    ...
    def __init__(self, constrainAtZero: bool = True, weights: Array = ..., optimizationMethod: base.OptimizationMethod = None, l2: Array = ..., minCutoffTime: typing.SupportsFloat | typing.SupportsIndex = 0.0, maxCutoffTime: typing.SupportsFloat | typing.SupportsIndex = 1.7976931348623157e+308, numCoeffs: typing.SupportsInt | typing.SupportsIndex = 9, fixedKappa: typing.Any = None, constraint: base.Constraint = ...) -> None:
        ...
        """
class ExtendedCoxIngersollRoss(CoxIngersollRoss, base.TermStructureConsistentModel):
    """
    ...
    def __init__(self, termStructure: base.YieldTermStructure, theta: typing.SupportsFloat | typing.SupportsIndex = 0.1, k: typing.SupportsFloat | typing.SupportsIndex = 0.1, sigma: typing.SupportsFloat | typing.SupportsIndex = 0.1, x0: typing.SupportsFloat | typing.SupportsIndex = 0.05, withFellerConstraint: bool = True) -> None:
        ...
        """
class ExtendedOUDiscretization:
    """
    ...
    Members:
      ...
      GaussLobatto
    """
    GaussLobatto: typing.ClassVar[ExtendedOUDiscretization]  # value = <ExtendedOUDiscretization.GaussLobatto: 2>
    MidPoint: typing.ClassVar[ExtendedOUDiscretization]  # value = <ExtendedOUDiscretization.MidPoint: 0>
    Trapezodial: typing.ClassVar[ExtendedOUDiscretization]  # value = <ExtendedOUDiscretization.Trapezodial: 1>
    __members__: typing.ClassVar[dict[str, ExtendedOUDiscretization]]  # value = {'MidPoint': <ExtendedOUDiscretization.MidPoint: 0>, 'Trapezodial': <ExtendedOUDiscretization.Trapezodial: 1>, 'GaussLobatto': <ExtendedOUDiscretization.GaussLobatto: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
    ...
    def value(self) -> int:
        ...
class ExtendedOrnsteinUhlenbeckProcess(base.StochasticProcess1D):
    """
    ...
    def x0(self) -> float:
        ...
        """
class FFTVarianceGammaEngine(base.PricingEngine):
    """
...
class Fd2dBlackScholesVanillaEngine(BasketOptionEngine):
    ...
    def __init__(self, process1: GeneralizedBlackScholesProcess, process2: GeneralizedBlackScholesProcess, correlation: typing.SupportsFloat | typing.SupportsIndex, xGrid: typing.SupportsInt | typing.SupportsIndex = 100, yGrid: typing.SupportsInt | typing.SupportsIndex = 100, tGrid: typing.SupportsInt | typing.SupportsIndex = 50, dampingSteps: typing.SupportsInt | typing.SupportsIndex = 0, schemeDesc: FdmSchemeDesc = ..., localVol: bool = False, illegalLocalVolOverwrite: typing.SupportsFloat | typing.SupportsIndex = -3.4028234663852886e+38) -> None:
        ...
        """
class FdBatesVanillaEngine(base.PricingEngine):
    """
    ...
    def __init__(self, model: BatesModel, dividends: ..., std: ..., tGrid: typing.SupportsInt | typing.SupportsIndex = 100, xGrid: typing.SupportsInt | typing.SupportsIndex = 100, vGrid: typing.SupportsInt | typing.SupportsIndex = 50, dampingSteps: typing.SupportsInt | typing.SupportsIndex = 0, schemeDesc: FdmSchemeDesc = ...) -> None:
        ...
        """
class FdBlackScholesAsianEngine(base.PricingEngine):
    """
    Finite-difference Black-Scholes discrete Asian engine.
    """
    def __init__(self, process: GeneralizedBlackScholesProcess, tGrid: typing.SupportsInt | typing.SupportsIndex = 100, xGrid: typing.SupportsInt | typing.SupportsIndex = 100, aGrid: typing.SupportsInt | typing.SupportsIndex = 50, schemeDesc: FdmSchemeDesc = ...) -> None:
        """
        Constructs engine.
        """
class FdBlackScholesBarrierEngine(base.PricingEngine):
    ...
    def __init__(self, process: GeneralizedBlackScholesProcess, tGrid: typing.SupportsInt | typing.SupportsIndex = 100, xGrid: typing.SupportsInt | typing.SupportsIndex = 100, dampingSteps: typing.SupportsInt | typing.SupportsIndex = 0, schemeDesc: FdmSchemeDesc = ..., localVol: bool = False, illegalLocalVolOverwrite: typing.SupportsFloat | typing.SupportsIndex = -3.4028234663852886e+38) -> None:
        ...
        """
class FdBlackScholesRebateEngine(base.PricingEngine):
    """
    ...
    def __init__(self, process: GeneralizedBlackScholesProcess, tGrid: typing.SupportsInt | typing.SupportsIndex = 100, xGrid: typing.SupportsInt | typing.SupportsIndex = 100, dampingSteps: typing.SupportsInt | typing.SupportsIndex = 0, schemeDesc: FdmSchemeDesc = ..., localVol: bool = False, illegalLocalVolOverwrite: typing.SupportsFloat | typing.SupportsIndex = -3.4028234663852886e+38) -> None:
        ...
        """
class FdBlackScholesShoutEngine(base.PricingEngine):
    """
...
class FdBlackScholesVanillaEngine(base.PricingEngine):
    ...
    def __init__(self, process: GeneralizedBlackScholesProcess, tGrid: typing.SupportsInt | typing.SupportsIndex = 100, xGrid: typing.SupportsInt | typing.SupportsIndex = 100, dampingSteps: typing.SupportsInt | typing.SupportsIndex = 0, schemeDesc: FdmSchemeDesc = ..., localVol: bool = False, illegalLocalVolOverwrite: typing.SupportsFloat | typing.SupportsIndex = -3.4028234663852886e+38, cashDividendModel: CashDividendModel = ...) -> None:
        ...
        """
class FdCEVVanillaEngine(base.PricingEngine):
    """
...
class FdG2SwaptionEngine(base.PricingEngine):
    ...
    def __init__(self, model: G2, tGrid: typing.SupportsInt | typing.SupportsIndex = 100, xGrid: typing.SupportsInt | typing.SupportsIndex = 50, yGrid: typing.SupportsInt | typing.SupportsIndex = 50, dampingSteps: typing.SupportsInt | typing.SupportsIndex = 0, invEps: typing.SupportsFloat | typing.SupportsIndex = 1e-05, schemeDesc: FdmSchemeDesc = ...) -> None:
        ...
        """
class FdHestonBarrierEngine(base.PricingEngine):
    """
    Finite-difference Heston barrier option engine.
    """
    def __init__(self, model: HestonModel, tGrid: typing.SupportsInt | typing.SupportsIndex = 100, xGrid: typing.SupportsInt | typing.SupportsIndex = 100, vGrid: typing.SupportsInt | typing.SupportsIndex = 50, dampingSteps: typing.SupportsInt | typing.SupportsIndex = 0, schemeDesc: FdmSchemeDesc = ...) -> None:
        """
        Constructs engine.
        """
class FdHestonDoubleBarrierEngine(base.PricingEngine):
    """
    ...
    def __init__(self, model: HestonModel, tGrid: typing.SupportsInt | typing.SupportsIndex = 100, xGrid: typing.SupportsInt | typing.SupportsIndex = 100, vGrid: typing.SupportsInt | typing.SupportsIndex = 50, dampingSteps: typing.SupportsInt | typing.SupportsIndex = 0, schemeDesc: FdmSchemeDesc = ...) -> None:
        ...
        Constructs engine.
        """
class FdHestonHullWhiteVanillaEngine(base.PricingEngine):
    """
    ...
    def __init__(self, model: HestonModel, hwProcess: HullWhiteProcess, dividends: collections.abc.Sequence[base.Dividend], corrEquityShortRate: typing.SupportsFloat | typing.SupportsIndex, tGrid: typing.SupportsInt | typing.SupportsIndex = 50, xGrid: typing.SupportsInt | typing.SupportsIndex = 100, vGrid: typing.SupportsInt | typing.SupportsIndex = 40, rGrid: typing.SupportsInt | typing.SupportsIndex = 20, dampingSteps: typing.SupportsInt | typing.SupportsIndex = 0, controlVariate: bool = True, schemeDesc: FdmSchemeDesc = ...) -> None:
        ...
        """
class FdHestonRebateEngine(base.PricingEngine):
    """
    ...
    def __init__(self, model: HestonModel, tGrid: typing.SupportsInt | typing.SupportsIndex = 100, xGrid: typing.SupportsInt | typing.SupportsIndex = 100, vGrid: typing.SupportsInt | typing.SupportsIndex = 50, dampingSteps: typing.SupportsInt | typing.SupportsIndex = 0, schemeDesc: FdmSchemeDesc = ...) -> None:
        ...
        Constructs engine.
        """
class FdHestonVanillaEngine(base.PricingEngine):
    """
...
class FdHullWhiteSwaptionEngine(base.PricingEngine):
    ...
    def __init__(self, model: HullWhite, tGrid: typing.SupportsInt | typing.SupportsIndex = 100, xGrid: typing.SupportsInt | typing.SupportsIndex = 100, dampingSteps: typing.SupportsInt | typing.SupportsIndex = 0, invEps: typing.SupportsFloat | typing.SupportsIndex = 1e-05, schemeDesc: FdmSchemeDesc = ...) -> None:
        ...
        """
class FdOrnsteinUhlenbeckVanillaEngine(base.PricingEngine):
    """
    ...
    def __init__(self, process: OrnsteinUhlenbeckProcess, riskFreeRate: base.YieldTermStructure, dividends: collections.abc.Sequence[base.Dividend], tGrid: typing.SupportsInt | typing.SupportsIndex = 100, xGrid: typing.SupportsInt | typing.SupportsIndex = 100, dampingSteps: typing.SupportsInt | typing.SupportsIndex = 0, epsilon: typing.SupportsFloat | typing.SupportsIndex = 0.0001, schemeDesc: FdmSchemeDesc = ...) -> None:
        ...
        """
class FdSabrVanillaEngine(base.PricingEngine):
    """
    ...
    def __init__(self, f0: typing.SupportsFloat | typing.SupportsIndex, alpha: typing.SupportsFloat | typing.SupportsIndex, beta: typing.SupportsFloat | typing.SupportsIndex, nu: typing.SupportsFloat | typing.SupportsIndex, rho: typing.SupportsFloat | typing.SupportsIndex, rTS: base.YieldTermStructure, tGrid: typing.SupportsInt | typing.SupportsIndex = 50, fGrid: typing.SupportsInt | typing.SupportsIndex = 400, xGrid: typing.SupportsInt | typing.SupportsIndex = 50, dampingSteps: typing.SupportsInt | typing.SupportsIndex = 0, scalingFactor: typing.SupportsFloat | typing.SupportsIndex = 1.0, eps: typing.SupportsFloat | typing.SupportsIndex = 0.0001, schemeDesc: FdmSchemeDesc = ...) -> None:
        ...
        """
class Fdm1DimSolver(base.LazyObject):
    """
    1D FDM solver with cubic interpolation.
    """
    def __init__(self, solverDesc: FdmSolverDesc, schemeDesc: FdmSchemeDesc, op: FdmLinearOpComposite) -> None:
        """
...
class Fdm1dMesher:
    ...
    def size(self) -> int:
        ...
        """
class Fdm2DimSolver(base.LazyObject):
    """
...
class Fdm2dBlackScholesOp(FdmLinearOpComposite):
    ...
    def __init__(self, mesher: FdmMesher, p1: GeneralizedBlackScholesProcess, p2: GeneralizedBlackScholesProcess, correlation: typing.SupportsFloat | typing.SupportsIndex, maturity: typing.SupportsFloat | typing.SupportsIndex, localVol: bool = False, illegalLocalVolOverwrite: typing.Any = None) -> None:
        ...
        """
class Fdm2dBlackScholesSolver(base.LazyObject):
    """
    Specialized 2D FDM solver for two-asset Black-Scholes.
    """
    @typing.overload
    def __init__(self, p1: GeneralizedBlackScholesProcessHandle, p2: GeneralizedBlackScholesProcessHandle, correlation: typing.SupportsFloat | typing.SupportsIndex, solverDesc: FdmSolverDesc, schemeDesc: FdmSchemeDesc = ..., localVol: bool = False, illegalLocalVolOverwrite: typing.Any = None) -> None:
        """
        Constructs from two BS process handles and correlation.
        """
    @typing.overload
    def __init__(self, p1: GeneralizedBlackScholesProcess, p2: GeneralizedBlackScholesProcess, correlation: typing.SupportsFloat | typing.SupportsIndex, solverDesc: FdmSolverDesc, schemeDesc: FdmSchemeDesc = ..., localVol: bool = False, illegalLocalVolOverwrite: typing.Any = None) -> None:
        """
        Constructs from two BS processes (handles created internally).
        """
    def deltaXat(self, x: typing.SupportsFloat | typing.SupportsIndex, y: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        Returns delta with respect to first asset.
        """
    def deltaYat(self, x: typing.SupportsFloat | typing.SupportsIndex, y: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        Returns delta with respect to second asset.
        """
    def gammaXYat(self, x: typing.SupportsFloat | typing.SupportsIndex, y: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        Returns cross-gamma between assets.
        """
    def gammaXat(self, x: typing.SupportsFloat | typing.SupportsIndex, y: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        Returns gamma with respect to first asset.
        """
    def gammaYat(self, x: typing.SupportsFloat | typing.SupportsIndex, y: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
    ...
    def thetaAt(self, x: typing.SupportsFloat | typing.SupportsIndex, y: typing.SupportsFloat | typing.SupportsIndex) -> float:
        ...
        Returns theta.
        """
    def valueAt(self, x: typing.SupportsFloat | typing.SupportsIndex, y: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        Returns option value at spot prices x and y.
        """
class Fdm3DimSolver(base.LazyObject):
    """
    ...
    def thetaAt(self, x: typing.SupportsFloat | typing.SupportsIndex, y: typing.SupportsFloat | typing.SupportsIndex, z: typing.SupportsFloat | typing.SupportsIndex) -> float:
        ...
        """
class FdmAmericanStepCondition(base.FdmStepCondition):
    """
    American-style early exercise step condition.
    """
    def __init__(self, mesher: FdmMesher, calculator: base.FdmInnerValueCalculator) -> None:
        """
        Constructs with mesher and inner value calculator.
        """
class FdmArithmeticAverageCondition(base.FdmStepCondition):
    """
    Arithmetic average step condition for Asian option FDM pricing.
    """
    def __init__(self, averageTimes: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], runningAverage: typing.SupportsFloat | typing.SupportsIndex, pastFixings: typing.SupportsInt | typing.SupportsIndex, mesher: FdmMesher, equityDirection: typing.SupportsInt | typing.SupportsIndex) -> None:
        """
...
class FdmBackwardSolver:
    ...
    """
    def __init__(self, map: ..., bcSet: collections.abc.Sequence[...] = [], condition: typing.Any = None, schemeDesc: FdmSchemeDesc = ...) -> None:
        """
...
class FdmBatesOp(FdmLinearOpComposite):
    ...
    def __init__(self, mesher: FdmMesher, batesProcess: BatesProcess, bcSet: collections.abc.Sequence[FdmBoundaryCondition], integroIntegrationOrder: typing.SupportsInt | typing.SupportsIndex, quantoHelper: FdmQuantoHelper = None) -> None:
        ...
        """
class FdmBatesSolver(base.LazyObject):
    """
    Specialized 2D FDM solver for Bates jump-diffusion model.
    """
    @typing.overload
    def __init__(self, process: BatesProcessHandle, solverDesc: FdmSolverDesc, schemeDesc: FdmSchemeDesc = ..., integroIntegrationOrder: typing.SupportsInt | typing.SupportsIndex = 12, quantoHelper: typing.Any = None) -> None:
        """
        Constructs from Bates process handle.
        """
    @typing.overload
    def __init__(self, process: BatesProcess, solverDesc: FdmSolverDesc, schemeDesc: FdmSchemeDesc = ..., integroIntegrationOrder: typing.SupportsInt | typing.SupportsIndex = 12, quantoHelper: typing.Any = None) -> None:
        """
        Constructs from Bates process (handle created internally).
        """
    def deltaAt(self, s: typing.SupportsFloat | typing.SupportsIndex, v: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        Returns delta at spot s and variance v.
        """
    def gammaAt(self, s: typing.SupportsFloat | typing.SupportsIndex, v: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        Returns gamma at spot s and variance v.
        """
    def thetaAt(self, s: typing.SupportsFloat | typing.SupportsIndex, v: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        Returns theta at spot s and variance v.
        """
    def valueAt(self, s: typing.SupportsFloat | typing.SupportsIndex, v: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        Returns option value at spot s and variance v.
        """
class FdmBermudanStepCondition(base.FdmStepCondition):
    """
    Bermudan-style early exercise step condition.
    """
    def __init__(self, exerciseDates: collections.abc.Sequence[Date], referenceDate: Date, dayCounter: DayCounter, mesher: FdmMesher, calculator: base.FdmInnerValueCalculator) -> None:
        """
...
class FdmBlackScholesOp(FdmLinearOpComposite):
    ...
    def __init__(self, mesher: FdmMesher, process: GeneralizedBlackScholesProcess, strike: typing.SupportsFloat | typing.SupportsIndex, localVol: bool = False, illegalLocalVolOverwrite: typing.Any = None, direction: typing.SupportsInt | typing.SupportsIndex = 0, quantoHelper: FdmQuantoHelper = None) -> None:
        ...
        """
class FdmBlackScholesSolver(base.LazyObject):
    """
    Specialized 1D FDM solver for Black-Scholes processes.
    """
    @typing.overload
    def __init__(self, process: GeneralizedBlackScholesProcessHandle, strike: typing.SupportsFloat | typing.SupportsIndex, solverDesc: FdmSolverDesc, schemeDesc: FdmSchemeDesc = ..., localVol: bool = False, illegalLocalVolOverwrite: typing.Any = None, quantoHelper: typing.Any = None) -> None:
        """
...
class FdmCEVOp(FdmLinearOpComposite):
    ...
    def __init__(self, mesher: FdmMesher, rTS: base.YieldTermStructure, f0: typing.SupportsFloat | typing.SupportsIndex, alpha: typing.SupportsFloat | typing.SupportsIndex, beta: typing.SupportsFloat | typing.SupportsIndex, direction: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
        """
class FdmCellAveragingInnerValue(base.FdmInnerValueCalculator):
    """
...
class FdmDirichletBoundary(FdmBoundaryCondition):
    ...
    """
    def __init__(self, mesher: FdmMesher, valueOnBoundary: typing.SupportsFloat | typing.SupportsIndex, direction: typing.SupportsInt | typing.SupportsIndex, side: BoundaryConditionSide) -> None:
        """
...
class FdmDiscountDirichletBoundary(FdmBoundaryCondition):
    ...
    """
    def __init__(self, mesher: FdmMesher, rTS: base.YieldTermStructure, maturityTime: typing.SupportsFloat | typing.SupportsIndex, valueOnBoundary: typing.SupportsFloat | typing.SupportsIndex, direction: typing.SupportsInt | typing.SupportsIndex, side: BoundaryConditionSide) -> None:
        """
        Constructs with mesher, yield curve, maturity time, boundary value, direction, and side.
        """
class FdmDividendHandler(base.FdmStepCondition):
    """
...
class FdmG2Op(FdmLinearOpComposite):
    ...
    def __init__(self, mesher: FdmMesher, model: ..., direction1: typing.SupportsInt | typing.SupportsIndex, direction2: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
        """
class FdmG2Solver(base.LazyObject):
    """
    Specialized 2D FDM solver for G2++ two-factor interest rate model.
    """
    @typing.overload
    def __init__(self, model: ..., solverDesc: FdmSolverDesc, schemeDesc: FdmSchemeDesc = ...) -> None:
        """
...
class FdmHestonFwdOp(FdmLinearOpComposite):
    ...
    def __init__(self, mesher: FdmMesher, process: HestonProcess, type: FdmSquareRootFwdOpTransformationType = ..., leverageFct: base.LocalVolTermStructure = None, mixingFactor: typing.SupportsFloat | typing.SupportsIndex = 1.0) -> None:
        ...
        """
class FdmHestonGreensFctAlgorithm:
    """
    ...
    Members:
      ...
      SemiAnalytical
    """
    Gaussian: typing.ClassVar[FdmHestonGreensFctAlgorithm]  # value = <FdmHestonGreensFctAlgorithm.Gaussian: 1>
    SemiAnalytical: typing.ClassVar[FdmHestonGreensFctAlgorithm]  # value = <FdmHestonGreensFctAlgorithm.SemiAnalytical: 2>
    ZeroCorrelation: typing.ClassVar[FdmHestonGreensFctAlgorithm]  # value = <FdmHestonGreensFctAlgorithm.ZeroCorrelation: 0>
    __members__: typing.ClassVar[dict[str, FdmHestonGreensFctAlgorithm]]  # value = {'ZeroCorrelation': <FdmHestonGreensFctAlgorithm.ZeroCorrelation: 0>, 'Gaussian': <FdmHestonGreensFctAlgorithm.Gaussian: 1>, 'SemiAnalytical': <FdmHestonGreensFctAlgorithm.SemiAnalytical: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class FdmHestonOp(FdmLinearOpComposite):
    ...
    def __init__(self, mesher: FdmMesher, hestonProcess: HestonProcess, quantoHelper: FdmQuantoHelper = None, leverageFct: base.LocalVolTermStructure = None, mixingFactor: typing.SupportsFloat | typing.SupportsIndex = 1.0) -> None:
        ...
        """
class FdmHestonSolver(base.LazyObject):
    """
    Specialized 2D FDM solver for Heston stochastic volatility.
    """
    @typing.overload
    def __init__(self, process: HestonProcessHandle, solverDesc: FdmSolverDesc, schemeDesc: FdmSchemeDesc = ..., quantoHelper: typing.Any = None, leverageFct: typing.Any = None, mixingFactor: typing.SupportsFloat | typing.SupportsIndex = 1.0) -> None:
        """
        Constructs from Heston process handle.
        """
    @typing.overload
    def __init__(self, process: HestonProcess, solverDesc: FdmSolverDesc, schemeDesc: FdmSchemeDesc = ..., quantoHelper: typing.Any = None, leverageFct: typing.Any = None, mixingFactor: typing.SupportsFloat | typing.SupportsIndex = 1.0) -> None:
        """
    ...
    def gammaAt(self, s: typing.SupportsFloat | typing.SupportsIndex, v: typing.SupportsFloat | typing.SupportsIndex) -> float:
        ...
        Returns gamma at spot s and variance v.
        """
    def meanVarianceDeltaAt(self, s: typing.SupportsFloat | typing.SupportsIndex, v: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        Returns mean-variance adjusted delta.
        """
    def meanVarianceGammaAt(self, s: typing.SupportsFloat | typing.SupportsIndex, v: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
...
class FdmHullWhiteOp(FdmLinearOpComposite):
    ...
    def __init__(self, mesher: FdmMesher, model: ..., direction: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
        """
class FdmHullWhiteSolver(base.LazyObject):
    """
    ...
    def __init__(self, model: ..., solverDesc: FdmSolverDesc, schemeDesc: FdmSchemeDesc = ...) -> None:
        ...
        """
    def valueAt(self, r: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
...
class FdmLinearOpIterator:
    ...
    def index(self) -> int:
        ...
        """
    def notEqual(self, other: FdmLinearOpIterator) -> bool:
        """
...
class FdmLocalVolFwdOp(FdmLinearOpComposite):
    ...
    def __init__(self, mesher: FdmMesher, spot: base.Quote, rTS: base.YieldTermStructure, qTS: base.YieldTermStructure, localVol: base.LocalVolTermStructure, direction: typing.SupportsInt | typing.SupportsIndex = 0) -> None:
        ...
        """
class FdmLogBasketInnerValue(base.FdmInnerValueCalculator):
    """
    Log-space inner value calculator for basket options.
    """
    def __init__(self, payoff: ..., mesher: FdmMesher) -> None:
        """
...
class FdmMesherComposite(FdmMesher):
    ...
    """
    @typing.overload
    def __init__(self, meshers: collections.abc.Sequence[Fdm1dMesher]) -> None:
        """
        Constructs from a vector of 1D meshers.
        """
    @typing.overload
    def __init__(self, layout: FdmLinearOpLayout, meshers: collections.abc.Sequence[Fdm1dMesher]) -> None:
        """
        Constructs from a layout and vector of 1D meshers.
        """
    @typing.overload
    def __init__(self, mesher: Fdm1dMesher) -> None:
        """
        Constructs a 1D composite mesher.
        """
    @typing.overload
    def __init__(self, m1: Fdm1dMesher, m2: Fdm1dMesher) -> None:
        """
        Constructs a 2D composite mesher.
        """
    @typing.overload
    def __init__(self, m1: Fdm1dMesher, m2: Fdm1dMesher, m3: Fdm1dMesher) -> None:
        """
        Constructs a 3D composite mesher.
        """
    @typing.overload
    def __init__(self, m1: Fdm1dMesher, m2: Fdm1dMesher, m3: Fdm1dMesher, m4: Fdm1dMesher) -> None:
        """
...
class FdmQuantoHelper(Observable):
    ...
    def quantoAdjustment(self, equityVol: Array, t1: typing.SupportsFloat | typing.SupportsIndex, t2: typing.SupportsFloat | typing.SupportsIndex) -> Array:
        ...
        """
    @property
    def equityFxCorrelation(self) -> float:
        ...
    @property
    def exchRateATMlevel(self) -> float:
        ...
    @property
    def fTS(self) -> base.YieldTermStructure:
        ...
    @property
    def fxVolTS(self) -> base.BlackVolTermStructure:
        ...
    @property
    def rTS(self) -> base.YieldTermStructure:
        ...
...
class FdmSimpleProcess1dMesher(Fdm1dMesher):
    ...
    def __init__(self, size: typing.SupportsInt | typing.SupportsIndex, process: base.StochasticProcess1D, maturity: typing.SupportsFloat | typing.SupportsIndex, tAvgSteps: typing.SupportsInt | typing.SupportsIndex = 10, epsilon: typing.SupportsFloat | typing.SupportsIndex = 0.0001, mandatoryPoint: typing.Any = None) -> None:
        ...
        """
class FdmSimpleSwingCondition(base.FdmStepCondition):
    """
    Simple swing option step condition for FDM pricing.
    """
    def __init__(self, exerciseTimes: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], mesher: FdmMesher, calculator: base.FdmInnerValueCalculator, swingDirection: typing.SupportsInt | typing.SupportsIndex, minExercises: typing.SupportsInt | typing.SupportsIndex = 0) -> None:
        """
        Constructs with exercise times, mesher, calculator, swing direction index, and minimum exercises.
        """
class FdmSnapshotCondition(base.FdmStepCondition):
    """
...
class FdmSolverDesc:
    ...
    def __init__(self, mesher: FdmMesher, bcSet: collections.abc.Sequence[FdmBoundaryCondition], condition: FdmStepConditionComposite, calculator: base.FdmInnerValueCalculator, maturity: typing.SupportsFloat | typing.SupportsIndex, timeSteps: typing.SupportsInt | typing.SupportsIndex, dampingSteps: typing.SupportsInt | typing.SupportsIndex = 0) -> None:
        ...
        """
    @property
    def bcSet(self) -> list[FdmBoundaryCondition]:
        ...
    @property
    def calculator(self) -> base.FdmInnerValueCalculator:
        ...
    @property
    def condition(self) -> FdmStepConditionComposite:
        ...
    @property
    def dampingSteps(self) -> int:
        ...
    @property
    def maturity(self) -> float:
        ...
    @property
    def mesher(self) -> FdmMesher:
        ...
    @property
...
class FdmSquareRootFwdOp(FdmLinearOpComposite):
    ...
    def __init__(self, mesher: FdmMesher, kappa: typing.SupportsFloat | typing.SupportsIndex, theta: typing.SupportsFloat | typing.SupportsIndex, sigma: typing.SupportsFloat | typing.SupportsIndex, direction: typing.SupportsInt | typing.SupportsIndex, type: FdmSquareRootFwdOpTransformationType = ...) -> None:
        ...
        """
    def lowerBoundaryFactor(self, type: FdmSquareRootFwdOpTransformationType = ...) -> float:
        """
        Returns the lower boundary factor.
        """
    def upperBoundaryFactor(self, type: FdmSquareRootFwdOpTransformationType = ...) -> float:
        """
    ...
    def v(self, i: typing.SupportsInt | typing.SupportsIndex) -> float:
        ...
        """
class FdmSquareRootFwdOpTransformationType:
    """
    ...
    Members:
      ...
      Log
    """
    Log: typing.ClassVar[FdmSquareRootFwdOpTransformationType]  # value = <FdmSquareRootFwdOpTransformationType.Log: 2>
    Plain: typing.ClassVar[FdmSquareRootFwdOpTransformationType]  # value = <FdmSquareRootFwdOpTransformationType.Plain: 0>
    Power: typing.ClassVar[FdmSquareRootFwdOpTransformationType]  # value = <FdmSquareRootFwdOpTransformationType.Power: 1>
    __members__: typing.ClassVar[dict[str, FdmSquareRootFwdOpTransformationType]]  # value = {'Plain': <FdmSquareRootFwdOpTransformationType.Plain: 0>, 'Power': <FdmSquareRootFwdOpTransformationType.Power: 1>, 'Log': <FdmSquareRootFwdOpTransformationType.Log: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
    ...
    def value(self) -> int:
        ...
class FdmStepConditionComposite(base.FdmStepCondition):
    """
    Composite of FDM step conditions.
    """
    @staticmethod
    def joinConditions(snapshotCondition: FdmSnapshotCondition, composite: FdmStepConditionComposite) -> FdmStepConditionComposite:
        """
        Joins a snapshot condition with an existing composite.
        """
    @staticmethod
    def vanillaComposite(dividendSchedule: collections.abc.Sequence[base.Dividend], exercise: Exercise, mesher: FdmMesher, calculator: base.FdmInnerValueCalculator, referenceDate: Date, dayCounter: DayCounter) -> FdmStepConditionComposite:
        """
    ...
    def __init__(self, stoppingTimes: collections.abc.Sequence[collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex]], conditions: collections.abc.Sequence[base.FdmStepCondition]) -> None:
        ...
        """
    def conditions(self) -> list[base.FdmStepCondition]:
        """
...
class FdmTimeDepDirichletBoundary(FdmBoundaryCondition):
    ...
    """
    def __init__(self, mesher: FdmMesher, valueOnBoundary: collections.abc.Callable[[typing.SupportsFloat | typing.SupportsIndex], float], direction: typing.SupportsInt | typing.SupportsIndex, side: BoundaryConditionSide) -> None:
        """
        Constructs with scalar time-dependent boundary value function.
        """
class FdmZeroInnerValue(base.FdmInnerValueCalculator):
    """
    Zero inner value calculator (always returns 0).
    """
    def __init__(self) -> None:
        ...
class FdndimBlackScholesVanillaEngine(base.PricingEngine):
    """
    N-dimensional finite-difference Black-Scholes basket engine.
    """
    @typing.overload
    def __init__(self, processes: collections.abc.Sequence[GeneralizedBlackScholesProcess], rho: Matrix, xGrids: collections.abc.Sequence[typing.SupportsInt | typing.SupportsIndex], tGrid: typing.SupportsInt | typing.SupportsIndex = 50, dampingSteps: typing.SupportsInt | typing.SupportsIndex = 0, schemeDesc: FdmSchemeDesc = ...) -> None:
        """
        Constructs with explicit per-dimension grid sizes.
        """
    @typing.overload
    def __init__(self, processes: collections.abc.Sequence[GeneralizedBlackScholesProcess], rho: Matrix, xGrid: typing.SupportsInt | typing.SupportsIndex, tGrid: typing.SupportsInt | typing.SupportsIndex = 50, dampingSteps: typing.SupportsInt | typing.SupportsIndex = 0, schemeDesc: FdmSchemeDesc = ...) -> None:
        """
...
class FittedBondDiscountCurve(base.YieldTermStructure, base.LazyObject):
    ...
    def resetGuess(self, guess: Array) -> None:
        ...
        """
class FixedDividend(base.Dividend):
    """
    Fixed cash dividend.
    """
    def __init__(self, amount: typing.SupportsFloat | typing.SupportsIndex, date: Date) -> None:
...
class FlatHazardRate(base.DefaultProbabilityTermStructure):
    ...
    def maxDate(self) -> Date:
        ...
        Maximum date.
        """
class FlatSmileSection(base.SmileSection):
    """
...
class FloatFloatSwap(Swap):
    ...
    def __init__(self, type: SwapType, nominal1: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], nominal2: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], schedule1: Schedule, index1: base.InterestRateIndex, dayCount1: DayCounter, schedule2: Schedule, index2: base.InterestRateIndex, dayCount2: DayCounter, intermediateCapitalExchange: bool = False, finalCapitalExchange: bool = False, gearing1: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex] = [], spread1: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex] = [], cappedRate1: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex] = [], flooredRate1: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex] = [], gearing2: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex] = [], spread2: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex] = [], cappedRate2: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex] = [], flooredRate2: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex] = [], paymentConvention1: typing.Any = None, paymentConvention2: typing.Any = None) -> None:
        ...
        """
    def cappedRate1(self) -> list[float]:
        """
        Returns leg 1 caps.
        """
    def cappedRate2(self) -> list[float]:
        """
        Returns leg 2 caps.
        """
    def dayCount1(self) -> DayCounter:
        """
        Returns leg 1 day counter.
        """
    def dayCount2(self) -> DayCounter:
        """
        Returns leg 2 day counter.
        """
    def flooredRate1(self) -> list[float]:
        """
        Returns leg 1 floors.
        """
    def flooredRate2(self) -> list[float]:
        """
    ...
    def gearing2(self) -> list[float]:
        ...
        """
    def index1(self) -> base.InterestRateIndex:
        """
        Returns leg 1 index.
        """
    def index2(self) -> base.InterestRateIndex:
        """
        Returns leg 2 index.
        """
    def leg1(self) -> list[base.CashFlow]:
        """
        Returns leg 1 cash flows.
        """
    def leg2(self) -> list[base.CashFlow]:
        """
    ...
    def nominal2(self) -> list[float]:
        ...
        """
    def paymentConvention1(self) -> BusinessDayConvention:
        """
        Returns leg 1 payment convention.
        """
    def paymentConvention2(self) -> BusinessDayConvention:
        """
    ...
    def type(self) -> SwapType:
        ...
        """
class FloatFloatSwaption(base.Option):
    """
    Option to enter into a float-float swap.
    """
    def __init__(self, swap: FloatFloatSwap, exercise: Exercise, delivery: SettlementType = ..., settlementMethod: SettlementMethod = ...) -> None:
        """
...
class FloatingRateCoupon(base.Coupon):
    ...
    def spread(self) -> float:
        ...
        """
class FloatingTypePayoff(base.Payoff):
    """
...
class ForwardCurve(base.YieldTermStructure):
    ...
    def times(self) -> list[float]:
        ...
        Returns the curve times.
        """
class ForwardEuropeanEngine(base.PricingEngine):
    """
    Forward-start European option engine (Black-Scholes).
    """
    def __init__(self, process: GeneralizedBlackScholesProcess) -> None:
        ...
class ForwardFlatInterpolation(base.Interpolation):
    """
    ...
    def __init__(self, x: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], y: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex]) -> None:
        ...
        Constructs interpolation from x and y arrays.
        """
class ForwardPerformanceEuropeanEngine(base.PricingEngine):
    """
...
class ForwardRateAgreement(base.Instrument):
    ...
    def isExpired(self) -> bool:
        ...
        Returns True if expired.
        """
class ForwardSpreadedTermStructure(base.YieldTermStructure):
    """
    Yield curve with an additive spread on forward rates.
    """
    @typing.overload
    def __init__(self, curveHandle: YieldTermStructureHandle, spreadHandle: QuoteHandle) -> None:
        """
        Constructs from yield curve and spread handles.
        """
    @typing.overload
    def __init__(self, curve: base.YieldTermStructure, spread: base.Quote) -> None:
        """
        Constructs from yield curve and spread (handles created internally).
        """
class ForwardTypePayoff(base.Payoff):
    """
    ...
    def strike(self) -> float:
        ...
        """
class ForwardVanillaOption(base.OneAssetOption):
    """
...
class FraRateHelper(base.RelativeDateRateHelper):
    ...
    def __init__(self, rate: typing.SupportsFloat | typing.SupportsIndex, periodToStart: Period, index: IborIndex, pillar: Pillar.Choice = ..., customPillarDate: Date = ..., useIndexedCoupon: bool = True) -> None:
        ...
        """
class FractionalDividend(base.Dividend):
    """
...
class G2(base.TwoFactorModel, base.AffineModel, base.TermStructureConsistentModel):
    ...
    def sigma(self) -> float:
        ...
        """
class G2ForwardProcess(base.ForwardMeasureProcess):
    """
    G2 forward-measure two-factor short-rate process.
    """
    def __init__(self, a: typing.SupportsFloat | typing.SupportsIndex, sigma: typing.SupportsFloat | typing.SupportsIndex, b: typing.SupportsFloat | typing.SupportsIndex, eta: typing.SupportsFloat | typing.SupportsIndex, rho: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
...
class G2Handle:
    ...
    def __bool__(self) -> bool:
        ...
        Checks if the handle is non-empty.
        """
    def __eq__(self, arg0: G2Handle) -> bool:
        ...
    @typing.overload
    def __init__(self) -> None:
        """
    ...
    def __init__(self, ptr: typing.Any, registerAsObserver: bool = True) -> None:
        ...
        Creates a handle linked to the given object.
        """
    def __lt__(self, arg0: G2Handle) -> bool:
        ...
    def __ne__(self, arg0: G2Handle) -> bool:
        ...
    def asObservable(self) -> Observable:
        """
        Converts to Observable for observer registration.
        """
    def currentLink(self) -> G2:
        """
        Returns the shared_ptr to the current object link.
        """
    def empty(self) -> bool:
    ...
    def get(self) -> G2:
        ...
        Returns the underlying shared_ptr. Raises error if empty.
        """
class G2Process(base.StochasticProcess):
    """
...
class GBPCurrency(Currency):
    ...
    def __init__(self) -> None:
        ...
class GBSMRNDCalculator(base.RiskNeutralDensityCalculator):
    """
...
class GHSCurrency(Currency):
    ...
    def __init__(self) -> None:
        ...
class GJRGARCHModel(base.CalibratedModel):
    """
    ...
    def v0(self) -> float:
        ...
        """
class GJRGARCHProcess(base.StochasticProcess):
    """
    ...
    def v0(self) -> float:
        ...
        """
class GJRGARCHProcessDiscretization:
    """
    ...
    Members:
      ...
      Reflection
    """
    FullTruncation: typing.ClassVar[GJRGARCHProcessDiscretization]  # value = <GJRGARCHProcessDiscretization.FullTruncation: 1>
    PartialTruncation: typing.ClassVar[GJRGARCHProcessDiscretization]  # value = <GJRGARCHProcessDiscretization.PartialTruncation: 0>
    Reflection: typing.ClassVar[GJRGARCHProcessDiscretization]  # value = <GJRGARCHProcessDiscretization.Reflection: 2>
    __members__: typing.ClassVar[dict[str, GJRGARCHProcessDiscretization]]  # value = {'PartialTruncation': <GJRGARCHProcessDiscretization.PartialTruncation: 0>, 'FullTruncation': <GJRGARCHProcessDiscretization.FullTruncation: 1>, 'Reflection': <GJRGARCHProcessDiscretization.Reflection: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class GarmanKohlhagenProcess(GeneralizedBlackScholesProcess):
    ...
    def __init__(self, x0: base.Quote, foreignRiskFreeTS: base.YieldTermStructure, domesticRiskFreeTS: base.YieldTermStructure, blackVolTS: base.BlackVolTermStructure, discretization: base.StochasticProcess1D.discretization, forceDiscretization: bool = False) -> None:
        ...
        Constructs from term structures with discretization (handles created internally).
        """
class GaussChebyshev2ndIntegration(base.GaussianQuadrature):
    """
    ...
    def __init__(self, n: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
        """
class GaussChebyshev2ndIntegrator(base.Integrator):
    """
    ...
    def __init__(self, n: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
        Constructs with n quadrature points.
        """
class GaussChebyshevIntegration(base.GaussianQuadrature):
    """
    ...
    def __init__(self, n: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
        Constructs with n quadrature points.
        """
class GaussChebyshevIntegrator(base.Integrator):
    """
    ...
    def __init__(self, n: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
        Constructs with n quadrature points.
        """
class GaussGegenbauerIntegration(base.GaussianQuadrature):
    """
    ...
    def __init__(self, n: typing.SupportsInt | typing.SupportsIndex, lambda_: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
        """
class GaussHermiteIntegration(base.GaussianQuadrature):
    """
    ...
    def __init__(self, n: typing.SupportsInt | typing.SupportsIndex, mu: typing.SupportsFloat | typing.SupportsIndex = 0.0) -> None:
        ...
        """
class GaussHyperbolicIntegration(base.GaussianQuadrature):
    """
    ...
    def __init__(self, n: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
        Constructs with n quadrature points.
        """
class GaussJacobiIntegration(base.GaussianQuadrature):
    """
    ...
    def __init__(self, n: typing.SupportsInt | typing.SupportsIndex, alpha: typing.SupportsFloat | typing.SupportsIndex, beta: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
        """
class GaussKronrodAdaptive(base.Integrator):
    """
    ...
    def __init__(self, tolerance: typing.SupportsFloat | typing.SupportsIndex, maxFunctionEvaluations: typing.Any = None) -> None:
        ...
        """
class GaussKronrodNonAdaptive(base.Integrator):
    """
    ...
    def __init__(self, absoluteAccuracy: typing.SupportsFloat | typing.SupportsIndex, maxEvaluations: typing.SupportsInt | typing.SupportsIndex, relativeAccuracy: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
        """
    def relativeAccuracy(self) -> float:
        """
        Returns the relative accuracy.
        """
class GaussLaguerreIntegration(base.GaussianQuadrature):
    """
    ...
    def __init__(self, n: typing.SupportsInt | typing.SupportsIndex, s: typing.SupportsFloat | typing.SupportsIndex = 0.0) -> None:
        ...
        """
class GaussLegendreIntegration(base.GaussianQuadrature):
    """
    ...
    def __init__(self, n: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
        Constructs with n quadrature points.
        """
class GaussLegendreIntegrator(base.Integrator):
    """
    ...
    def __init__(self, n: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
        Constructs with n quadrature points.
        """
class GaussLobattoIntegral(base.Integrator):
    """
    ...
    def __init__(self, maxIterations: typing.SupportsInt | typing.SupportsIndex, absAccuracy: typing.SupportsFloat | typing.SupportsIndex, relAccuracy: typing.Any = None, useConvergenceEstimate: bool = True) -> None:
        ...
        """
class Gaussian1dCapFloorEngine(base.PricingEngine):
    """
    ...
    def __init__(self, model: base.Gaussian1dModel, integrationPoints: typing.SupportsInt | typing.SupportsIndex = 64, stddevs: typing.SupportsFloat | typing.SupportsIndex = 7.0, extrapolatePayoff: bool = True, flatPayoffExtrapolation: bool = False, discountCurve: YieldTermStructureHandle = ...) -> None:
        ...
        """
class Gaussian1dFloatFloatSwaptionEngine(base.PricingEngine):
    """
    ...
    class Probabilities:
        ...
        __members__: typing.ClassVar[dict[str, Gaussian1dFloatFloatSwaptionEngine.Probabilities]]  # value = {'None_': <Probabilities.None_: 0>, 'Naive': <Probabilities.Naive: 1>, 'Digital': <Probabilities.Digital: 2>}
        def __eq__(self, other: typing.Any) -> bool:
            ...
        def __getstate__(self) -> int:
            ...
    ...
    def __init__(self, model: base.Gaussian1dModel, integrationPoints: typing.SupportsInt | typing.SupportsIndex = 64, stddevs: typing.SupportsFloat | typing.SupportsIndex = 7.0, extrapolatePayoff: bool = True, flatPayoffExtrapolation: bool = False, oas: QuoteHandle = ..., discountCurve: YieldTermStructureHandle = ..., includeTodaysExercise: bool = False, probabilities: Gaussian1dFloatFloatSwaptionEngine.Probabilities = ...) -> None:
        ...
        """
class Gaussian1dJamshidianSwaptionEngine(base.PricingEngine):
    """
    Gaussian 1-D Jamshidian swaption engine (analytic decomposition).
    """
    def __init__(self, model: base.Gaussian1dModel) -> None:
        """
        Constructs Jamshidian swaption engine.
        """
class Gaussian1dModelHandle:
    """
    ...
    def __bool__(self) -> bool:
        ...
        Checks if the handle is non-empty.
        """
    def __eq__(self, arg0: Gaussian1dModelHandle) -> bool:
        ...
    @typing.overload
    def __init__(self) -> None:
        """
    ...
    def __init__(self, ptr: typing.Any, registerAsObserver: bool = True) -> None:
        ...
        Creates a handle linked to the given object.
        """
    def __lt__(self, arg0: Gaussian1dModelHandle) -> bool:
        ...
    def __ne__(self, arg0: Gaussian1dModelHandle) -> bool:
        ...
    def asObservable(self) -> Observable:
        """
        Converts to Observable for observer registration.
        """
    def currentLink(self) -> base.Gaussian1dModel:
        """
        Returns the shared_ptr to the current object link.
        """
    def empty(self) -> bool:
        ...
        Returns true if the handle is empty.
        """
    def get(self) -> base.Gaussian1dModel:
        """
        Returns the underlying shared_ptr. Raises error if empty.
        """
class Gaussian1dNonstandardSwaptionEngine(base.PricingEngine):
    """
    ...
    class Probabilities:
        ...
        __members__: typing.ClassVar[dict[str, Gaussian1dNonstandardSwaptionEngine.Probabilities]]  # value = {'None_': <Probabilities.None_: 0>, 'Naive': <Probabilities.Naive: 1>, 'Digital': <Probabilities.Digital: 2>}
        def __eq__(self, other: typing.Any) -> bool:
            ...
        def __getstate__(self) -> int:
            ...
    ...
    def __init__(self, model: base.Gaussian1dModel, integrationPoints: typing.SupportsInt | typing.SupportsIndex = 64, stddevs: typing.SupportsFloat | typing.SupportsIndex = 7.0, extrapolatePayoff: bool = True, flatPayoffExtrapolation: bool = False, oas: QuoteHandle = ..., discountCurve: YieldTermStructureHandle = ..., probabilities: Gaussian1dNonstandardSwaptionEngine.Probabilities = ...) -> None:
        ...
        """
class Gaussian1dSwaptionEngine(base.PricingEngine):
    """
    ...
    class Probabilities:
        ...
        __members__: typing.ClassVar[dict[str, Gaussian1dSwaptionEngine.Probabilities]]  # value = {'None_': <Probabilities.None_: 0>, 'Naive': <Probabilities.Naive: 1>, 'Digital': <Probabilities.Digital: 2>}
        def __eq__(self, other: typing.Any) -> bool:
            ...
        def __getstate__(self) -> int:
            ...
...
class GaussianLowDiscrepancySequenceGenerator:
    """
    Gaussian low-discrepancy sequence generator via inverse cumulative normal (uses Sobol).
    """
    @typing.overload
    def __init__(self, uniformSequenceGenerator: SobolRsg) -> None:
        """
...
class GaussianMultiPathGenerator:
    ...
    """
    def __init__(self, process: base.StochasticProcess, timeGrid: TimeGrid, generator: GaussianRandomSequenceGenerator, brownianBridge: bool = False) -> None:
        """
        Constructs from process, time grid, and generator.
        """
    def antithetic(self) -> SampleMultiPath:
        """
        Generates the antithetic multi-path sample.
        """
    def next(self) -> SampleMultiPath:
        """
...
class GaussianPathGenerator:
    ...
    def __init__(self, process: base.StochasticProcess, length: typing.SupportsFloat | typing.SupportsIndex, timeSteps: typing.SupportsInt | typing.SupportsIndex, generator: GaussianRandomSequenceGenerator, brownianBridge: bool) -> None:
        ...
        """
    @typing.overload
    def __init__(self, process: base.StochasticProcess, timeGrid: TimeGrid, generator: GaussianRandomSequenceGenerator, brownianBridge: bool) -> None:
        """
        Constructs from process, time grid, and generator.
        """
    def antithetic(self) -> SamplePath:
        """
        Generates the antithetic path sample.
        """
    def next(self) -> SamplePath:
        """
...
class GaussianRandomGenerator:
    """
    Gaussian random number generator via inverse cumulative normal (uses Mersenne Twister).
    """
    @typing.overload
    def __init__(self, uniformGenerator: MersenneTwisterUniformRng) -> None:
        """
...
class GaussianRandomSequenceGenerator:
    """
    Gaussian random sequence generator via inverse cumulative normal (uses Mersenne Twister).
    """
    @typing.overload
    def __init__(self, uniformSequenceGenerator: UniformRandomSequenceGenerator) -> None:
        """
...
class GaussianSobolMultiPathGenerator:
    ...
    """
    def __init__(self, process: base.StochasticProcess, timeGrid: TimeGrid, generator: GaussianLowDiscrepancySequenceGenerator, brownianBridge: bool = False) -> None:
        """
        Constructs from process, time grid, and generator.
        """
    def antithetic(self) -> SampleMultiPath:
...
class GaussianSobolPathGenerator:
    ...
    def __init__(self, process: base.StochasticProcess, length: typing.SupportsFloat | typing.SupportsIndex, timeSteps: typing.SupportsInt | typing.SupportsIndex, generator: GaussianLowDiscrepancySequenceGenerator, brownianBridge: bool) -> None:
        ...
        """
    @typing.overload
    def __init__(self, process: base.StochasticProcess, timeGrid: TimeGrid, generator: GaussianLowDiscrepancySequenceGenerator, brownianBridge: bool) -> None:
        """
        Constructs from process, time grid, and generator.
        """
    def antithetic(self) -> SamplePath:
...
class GeneralizedBlackScholesProcess(base.StochasticProcess1D):
    ...
    def stateVariable(self) -> QuoteHandle:
        ...
        """
class GeneralizedBlackScholesProcessHandle:
    """
    ...
    def __bool__(self) -> bool:
        ...
        Checks if the handle is non-empty.
        """
    def __eq__(self, arg0: GeneralizedBlackScholesProcessHandle) -> bool:
        ...
    @typing.overload
    def __init__(self) -> None:
        """
    ...
    def __init__(self, ptr: typing.Any, registerAsObserver: bool = True) -> None:
        ...
        Creates a handle linked to the given object.
        """
    def __lt__(self, arg0: GeneralizedBlackScholesProcessHandle) -> bool:
        ...
    def __ne__(self, arg0: GeneralizedBlackScholesProcessHandle) -> bool:
        ...
    def asObservable(self) -> Observable:
        """
        Converts to Observable for observer registration.
        """
    def currentLink(self) -> GeneralizedBlackScholesProcess:
        """
        Returns the shared_ptr to the current object link.
        """
    def empty(self) -> bool:
        ...
        Returns true if the handle is empty.
        """
    def get(self) -> GeneralizedBlackScholesProcess:
        """
        Returns the underlying shared_ptr. Raises error if empty.
        """
class GeometricBrownianMotionProcess(base.StochasticProcess1D):
    """
...
class Glued1dMesher(Fdm1dMesher):
    ...
    """
    def __init__(self, leftMesher: Fdm1dMesher, rightMesher: Fdm1dMesher) -> None:
        """
...
class Gsr(base.Gaussian1dModel, base.CalibratedModel):
    ...
    """
    def FixedReversions(self) -> list[bool]:
        """
        Returns fix-parameter mask with all reversions fixed.
        """
    def FixedVolatilities(self) -> list[bool]:
        """
...
class HaltonRsg:
    ...
    def nextSequence(self) -> ...:
        ...
        Returns next sample sequence.
        """
class HestonBlackVolSurface(base.BlackVolTermStructure):
    """
    Black volatility surface implied by a Heston model.
    """
    @typing.overload
    def __init__(self, hestonModel: ...) -> None:
        """
    ...
    def __init__(self, hestonModel: ...) -> None:
        ...
        """
class HestonExpansionEngine(base.PricingEngine):
    """
...
class HestonExpansionFormula:
    ...
    Members:
      ...
      Forde
    """
    Forde: typing.ClassVar[HestonExpansionFormula]  # value = <HestonExpansionFormula.Forde: 2>
    LPP2: typing.ClassVar[HestonExpansionFormula]  # value = <HestonExpansionFormula.LPP2: 0>
    LPP3: typing.ClassVar[HestonExpansionFormula]  # value = <HestonExpansionFormula.LPP3: 1>
    __members__: typing.ClassVar[dict[str, HestonExpansionFormula]]  # value = {'LPP2': <HestonExpansionFormula.LPP2: 0>, 'LPP3': <HestonExpansionFormula.LPP3: 1>, 'Forde': <HestonExpansionFormula.Forde: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class HestonProcessHandle:
    ...
    def __bool__(self) -> bool:
        ...
        Checks if the handle is non-empty.
        """
    def __eq__(self, arg0: HestonProcessHandle) -> bool:
        ...
    @typing.overload
    def __init__(self) -> None:
        """
    ...
    def __init__(self, ptr: typing.Any, registerAsObserver: bool = True) -> None:
        ...
        Creates a handle linked to the given object.
        """
    def __lt__(self, arg0: HestonProcessHandle) -> bool:
        ...
    def __ne__(self, arg0: HestonProcessHandle) -> bool:
        ...
    def asObservable(self) -> Observable:
        """
        Converts to Observable for observer registration.
        """
    def currentLink(self) -> HestonProcess:
        """
        Returns the shared_ptr to the current object link.
        """
    def empty(self) -> bool:
        ...
        Returns true if the handle is empty.
        """
    def get(self) -> HestonProcess:
        """
        Returns the underlying shared_ptr. Raises error if empty.
        """
class HestonRNDCalculator(base.RiskNeutralDensityCalculator):
    """
    ...
    def __init__(self, hestonProcess: HestonProcess, integrationEps: typing.SupportsFloat | typing.SupportsIndex = 1e-06, maxIntegrationIterations: typing.SupportsInt | typing.SupportsIndex = 10000) -> None:
        ...
        """
class HestonSLVFDMModel(base.LazyObject):
    """
    ...
    def hestonProcess(self) -> HestonProcess:
        ...
        """
    def leverageFunction(self) -> base.LocalVolTermStructure:
        """
        Returns the calibrated leverage function.
        """
    def localVol(self) -> base.LocalVolTermStructure:
        """
...
class HestonSLVMCModel(base.LazyObject):
    ...
    def localVol(self) -> base.LocalVolTermStructure:
        ...
        Returns the local volatility surface.
        """
class HestonSLVProcess(base.StochasticProcess):
    """
    ...
    def kappa(self) -> float:
        ...
        Returns mean reversion speed.
        """
    def leverageFct(self) -> base.LocalVolTermStructure:
        """
        Returns leverage function.
        """
    def mixingFactor(self) -> float:
        """
    ...
    def v0(self) -> float:
        ...
        Returns initial variance.
        """
class HolderExtensibleOption(base.OneAssetOption):
    """
...
class HullWhite(Vasicek, base.TermStructureConsistentModel):
    ...
    def discountBondOption(self, type: OptionType, strike: typing.SupportsFloat | typing.SupportsIndex, maturity: typing.SupportsFloat | typing.SupportsIndex, bondMaturity: typing.SupportsFloat | typing.SupportsIndex) -> float:
        ...
        Returns discount bond option price.
        """
class HullWhiteForwardProcess(base.ForwardMeasureProcess1D):
    """
...
class HullWhiteHandle:
    ...
    def __bool__(self) -> bool:
        ...
        Checks if the handle is non-empty.
        """
    def __eq__(self, arg0: HullWhiteHandle) -> bool:
        ...
    @typing.overload
    def __init__(self) -> None:
        """
    ...
    def __init__(self, ptr: typing.Any, registerAsObserver: bool = True) -> None:
        ...
        Creates a handle linked to the given object.
        """
    def __lt__(self, arg0: HullWhiteHandle) -> bool:
        ...
    def __ne__(self, arg0: HullWhiteHandle) -> bool:
        ...
    def asObservable(self) -> Observable:
        """
        Converts to Observable for observer registration.
        """
    def currentLink(self) -> HullWhite:
        """
        Returns the shared_ptr to the current object link.
        """
    def empty(self) -> bool:
        ...
        Returns true if the handle is empty.
        """
    def get(self) -> HullWhite:
        """
        Returns the underlying shared_ptr. Raises error if empty.
        """
class HullWhiteProcess(base.StochasticProcess1D):
    """
...
class Hungary(Calendar):
    ...
    def __init__(self) -> None:
        ...
class HybridHestonHullWhiteProcess(base.StochasticProcess):
    """
    ...
    class Discretization:
        ...
        Members:
          ...
          BSMHullWhite
        """
        BSMHullWhite: typing.ClassVar[HybridHestonHullWhiteProcess.Discretization]  # value = <Discretization.BSMHullWhite: 1>
        Euler: typing.ClassVar[HybridHestonHullWhiteProcess.Discretization]  # value = <Discretization.Euler: 0>
        __members__: typing.ClassVar[dict[str, HybridHestonHullWhiteProcess.Discretization]]  # value = {'Euler': <Discretization.Euler: 0>, 'BSMHullWhite': <Discretization.BSMHullWhite: 1>}
        def __eq__(self, other: typing.Any) -> bool:
            ...
        def __getstate__(self) -> int:
            ...
    ...
    BSMHullWhite: typing.ClassVar[HybridHestonHullWhiteProcess.Discretization]  # value = <Discretization.BSMHullWhite: 1>
    Euler: typing.ClassVar[HybridHestonHullWhiteProcess.Discretization]  # value = <Discretization.Euler: 0>
    def __init__(self, hestonProcess: HestonProcess, hullWhiteProcess: HullWhiteForwardProcess, corrEquityShortRate: typing.SupportsFloat | typing.SupportsIndex, discretization: HybridHestonHullWhiteProcess.Discretization = ...) -> None:
        """
    ...
    def hestonProcess(self) -> HestonProcess:
        ...
        Returns the Heston process.
        """
    def hullWhiteProcess(self) -> HullWhiteForwardProcess:
        """
...
class ImplicitEulerSolverType:
    ...
    Members:
      ...
      GMRES
    """
    BiCGstab: typing.ClassVar[ImplicitEulerSolverType]  # value = <ImplicitEulerSolverType.BiCGstab: 0>
    GMRES: typing.ClassVar[ImplicitEulerSolverType]  # value = <ImplicitEulerSolverType.GMRES: 1>
    __members__: typing.ClassVar[dict[str, ImplicitEulerSolverType]]  # value = {'BiCGstab': <ImplicitEulerSolverType.BiCGstab: 0>, 'GMRES': <ImplicitEulerSolverType.GMRES: 1>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
    ...
    def value(self) -> int:
        ...
class ImpliedTermStructure(base.YieldTermStructure):
    """
    Implied yield term structure at a future reference date.
    """
    @typing.overload
    def __init__(self, curveHandle: YieldTermStructureHandle, referenceDate: Date) -> None:
        """
        Constructs from yield curve handle and reference date.
        """
    @typing.overload
    def __init__(self, curve: base.YieldTermStructure, referenceDate: Date) -> None:
        """
...
class JpyLiborSwapIsdaFixPm(SwapIndex):
    ...
    def __init__(self, tenor: Period, forwardingTermStructure: ..., discountingTermStructure: ...) -> None:
        ...
        Constructs with forwarding and discounting term structures.
        """
class JuQuadraticApproximationEngine(base.PricingEngine):
    """
...
class KahaleSmileSection(base.SmileSection):
    ...
    """
    def __init__(self, source: typing.Any, atm: typing.Any = None, interpolate: bool = False, exponentialExtrapolation: bool = False, deleteArbitragePoints: bool = False, moneynessGrid: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex] = [], gap: typing.SupportsFloat | typing.SupportsIndex = 1e-05, forcedLeftIndex: typing.SupportsInt | typing.SupportsIndex = -1, forcedRightIndex: typing.SupportsInt | typing.SupportsIndex = 2147483647) -> None:
        """
...
class LVLCurrency(Currency):
    ...
    def __init__(self) -> None:
        ...
class LagrangeInterpolation(base.Interpolation):
    """
...
class LocalConstantVol(base.LocalVolTermStructure):
    ...
    def __init__(self, settlementDays: typing.SupportsInt | typing.SupportsIndex, calendar: Calendar, volatility: base.Quote, dayCounter: DayCounter) -> None:
        ...
        Constructs from settlement days and quote (handle created internally).
        """
class LocalVolRNDCalculator(base.RiskNeutralDensityCalculator):
    """
    Risk-neutral density calculator using local volatility and FDM.
    """
    @typing.overload
    def __init__(self, spot: base.Quote, rTS: base.YieldTermStructure, qTS: base.YieldTermStructure, localVol: base.LocalVolTermStructure, xGrid: typing.SupportsInt | typing.SupportsIndex = 101, tGrid: typing.SupportsInt | typing.SupportsIndex = 51, x0Density: typing.SupportsFloat | typing.SupportsIndex = 0.1, localVolProbEps: typing.SupportsFloat | typing.SupportsIndex = 1e-06, maxIter: typing.SupportsInt | typing.SupportsIndex = 10000, gaussianStepSize: typing.Any = None) -> None:
        """
        Constructs from spot, yield curves, local vol surface, and grid parameters.
        """
    @typing.overload
    def __init__(self, spot: base.Quote, rTS: base.YieldTermStructure, qTS: base.YieldTermStructure, localVol: base.LocalVolTermStructure, timeGrid: TimeGrid, xGrid: typing.SupportsInt | typing.SupportsIndex = 101, x0Density: typing.SupportsFloat | typing.SupportsIndex = 0.1, eps: typing.SupportsFloat | typing.SupportsIndex = 1e-06, maxIter: typing.SupportsInt | typing.SupportsIndex = 10000, gaussianStepSize: typing.Any = None) -> None:
        """
    ...
    def invcdf(self, p: typing.SupportsFloat | typing.SupportsIndex, t: typing.SupportsFloat | typing.SupportsIndex) -> float:
        ...
        """
    def mesher(self, t: typing.SupportsFloat | typing.SupportsIndex) -> Fdm1dMesher:
        """
...
class MCLDEuropeanBasketEngine(base.PricingEngine):
    ...
    def __init__(self, process: StochasticProcessArray, timeSteps: typing.SupportsInt | typing.SupportsIndex = ..., timeStepsPerYear: typing.SupportsInt | typing.SupportsIndex = ..., brownianBridge: bool = False, antitheticVariate: bool = False, requiredSamples: typing.SupportsInt | typing.SupportsIndex = ..., requiredTolerance: typing.SupportsFloat | typing.SupportsIndex = ..., maxSamples: typing.SupportsInt | typing.SupportsIndex = ..., seed: typing.SupportsInt | typing.SupportsIndex = 0) -> None:
        ...
        """
class MTBrownianGenerator(base.BrownianGenerator):
    """
    ...
    def __init__(self, factors: typing.SupportsInt | typing.SupportsIndex, steps: typing.SupportsInt | typing.SupportsIndex, seed: typing.SupportsInt | typing.SupportsIndex = 0) -> None:
        ...
        """
class MTBrownianGeneratorFactory(base.BrownianGeneratorFactory):
    """
...
class MakeFdHestonVanillaEngine:
    ...
    """
    def __init__(self, hestonModel: HestonModel) -> None:
        """
        Constructs the builder.
        """
    def engine(self) -> base.PricingEngine:
        """
...
class MakeYoYInflationCapFloor:
    ...
    def __init__(self, type: YoYInflationCapFloorType, index: YoYInflationIndex, length: typing.SupportsInt | typing.SupportsIndex, calendar: Calendar, observationLag: Period, interpolation: CPI.InterpolationType) -> None:
        ...
        """
    def asOptionlet(self, flag: bool = True) -> MakeYoYInflationCapFloor:
        ...
    def capFloor(self) -> YoYInflationCapFloor:
        """
        Builds and returns the YoY inflation cap/floor.
        """
    def withAtmStrike(self, nominalTermStructure: YieldTermStructureHandle) -> MakeYoYInflationCapFloor:
        ...
    ...
    def withPaymentAdjustment(self, convention: BusinessDayConvention) -> MakeYoYInflationCapFloor:
        ...
    def withPaymentDayCounter(self, dayCounter: DayCounter) -> MakeYoYInflationCapFloor:
        ...
...
class MargrabeOption(base.MultiAssetOption):
    ...
    def gamma2(self) -> float:
        ...
        Returns gamma with respect to second asset.
        """
class MarkovFunctional(base.Gaussian1dModel, base.CalibratedModel):
    """
    ...
    def __init__(self, termStructure: base.YieldTermStructure, reversion: typing.SupportsFloat | typing.SupportsIndex, volstepdates: collections.abc.Sequence[Date], volatilities: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], capletVol: OptionletVolatilityStructureHandle, capletExpiries: collections.abc.Sequence[Date], iborIndex: IborIndex, modelSettings: MarkovFunctionalModelSettings = ...) -> None:
        ...
        """
    def modelOutputs(self) -> MarkovFunctionalModelOutputs:
        """
        Returns diagnostic model outputs.
        """
    def modelSettings(self) -> MarkovFunctionalModelSettings:
        """
        Returns the model settings.
        """
    def numeraireDate(self) -> Date:
        """
    ...
    def volatility(self) -> Array:
        ...
        Returns the volatility parameters.
        """
class MarkovFunctionalAdjustments:
    """
    ...
    Members:
      ...
      CustomSmile
    """
    AdjustDigitals: typing.ClassVar[MarkovFunctionalAdjustments]  # value = <MarkovFunctionalAdjustments.AdjustDigitals: 1>
    AdjustNone: typing.ClassVar[MarkovFunctionalAdjustments]  # value = <MarkovFunctionalAdjustments.AdjustNone: 0>
    AdjustYts: typing.ClassVar[MarkovFunctionalAdjustments]  # value = <MarkovFunctionalAdjustments.AdjustYts: 2>
    CustomSmile: typing.ClassVar[MarkovFunctionalAdjustments]  # value = <MarkovFunctionalAdjustments.CustomSmile: 512>
    ExtrapolatePayoffFlat: typing.ClassVar[MarkovFunctionalAdjustments]  # value = <MarkovFunctionalAdjustments.ExtrapolatePayoffFlat: 4>
    KahaleInterpolation: typing.ClassVar[MarkovFunctionalAdjustments]  # value = <MarkovFunctionalAdjustments.KahaleInterpolation: 64>
    KahaleSmile: typing.ClassVar[MarkovFunctionalAdjustments]  # value = <MarkovFunctionalAdjustments.KahaleSmile: 16>
    NoPayoffExtrapolation: typing.ClassVar[MarkovFunctionalAdjustments]  # value = <MarkovFunctionalAdjustments.NoPayoffExtrapolation: 8>
    SabrSmile: typing.ClassVar[MarkovFunctionalAdjustments]  # value = <MarkovFunctionalAdjustments.SabrSmile: 256>
    SmileDeleteArbitragePoints: typing.ClassVar[MarkovFunctionalAdjustments]  # value = <MarkovFunctionalAdjustments.SmileDeleteArbitragePoints: 128>
    SmileExponentialExtrapolation: typing.ClassVar[MarkovFunctionalAdjustments]  # value = <MarkovFunctionalAdjustments.SmileExponentialExtrapolation: 32>
    __members__: typing.ClassVar[dict[str, MarkovFunctionalAdjustments]]  # value = {'AdjustNone': <MarkovFunctionalAdjustments.AdjustNone: 0>, 'AdjustDigitals': <MarkovFunctionalAdjustments.AdjustDigitals: 1>, 'AdjustYts': <MarkovFunctionalAdjustments.AdjustYts: 2>, 'ExtrapolatePayoffFlat': <MarkovFunctionalAdjustments.ExtrapolatePayoffFlat: 4>, 'NoPayoffExtrapolation': <MarkovFunctionalAdjustments.NoPayoffExtrapolation: 8>, 'KahaleSmile': <MarkovFunctionalAdjustments.KahaleSmile: 16>, 'SmileExponentialExtrapolation': <MarkovFunctionalAdjustments.SmileExponentialExtrapolation: 32>, 'KahaleInterpolation': <MarkovFunctionalAdjustments.KahaleInterpolation: 64>, 'SmileDeleteArbitragePoints': <MarkovFunctionalAdjustments.SmileDeleteArbitragePoints: 128>, 'SabrSmile': <MarkovFunctionalAdjustments.SabrSmile: 256>, 'CustomSmile': <MarkovFunctionalAdjustments.CustomSmile: 512>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class MarkovFunctionalModelOutputs:
    ...
    """
    @property
    def adjustmentFactors(self) -> list[float]:
        ...
    @property
    def annuity(self) -> list[float]:
        ...
    @property
    def atm(self) -> list[float]:
        ...
    @property
    def digitalsAdjustmentFactors(self) -> list[float]:
        ...
    @property
    def dirty(self) -> bool:
        ...
    ...
    def expiries(self) -> list[Date]:
        ...
    @property
    def marketCallPremium(self) -> list[list[float]]:
        ...
    @property
    def marketPutPremium(self) -> list[list[float]]:
        ...
    @property
    def marketRawCallPremium(self) -> list[list[float]]:
        ...
    @property
    def marketRawPutPremium(self) -> list[list[float]]:
        ...
    @property
    def marketVega(self) -> list[list[float]]:
        ...
    @property
    def marketZerorate(self) -> list[float]:
        ...
    @property
    def messages(self) -> list[str]:
        ...
    @property
    def modelCallPremium(self) -> list[list[float]]:
        ...
    @property
    def modelPutPremium(self) -> list[list[float]]:
        ...
    @property
    def modelZerorate(self) -> list[float]:
        ...
    @property
    def settings(self) -> MarkovFunctionalModelSettings:
        ...
    @property
    def smileStrikes(self) -> list[list[float]]:
        ...
    @property
...
class MersenneTwisterUniformRng:
    ...
    def nextReal(self) -> float:
        ...
        """
class Merton76Process(base.StochasticProcess1D):
    """
    Merton jump-diffusion process.
    """
    @typing.overload
    def __init__(self, stateVariable: QuoteHandle, dividendTS: YieldTermStructureHandle, riskFreeTS: YieldTermStructureHandle, blackVolTS: BlackVolTermStructureHandle, jumpIntensity: QuoteHandle, logMeanJump: QuoteHandle, logJumpVolatility: QuoteHandle) -> None:
        """
        Constructs from handles.
        """
    @typing.overload
    def __init__(self, stateVariable: base.Quote, dividendTS: base.YieldTermStructure, riskFreeTS: base.YieldTermStructure, blackVolTS: base.BlackVolTermStructure, jumpIntensity: base.Quote, logMeanJump: base.Quote, logJumpVolatility: base.Quote) -> None:
        """
    ...
    def dividendYield(self) -> YieldTermStructureHandle:
        ...
        Returns dividend yield handle.
        """
    def jumpIntensity(self) -> QuoteHandle:
        """
        Returns jump intensity handle.
        """
    def logJumpVolatility(self) -> QuoteHandle:
        """
        Returns log jump volatility handle.
        """
    def logMeanJump(self) -> QuoteHandle:
        """
...
class MidPointCdsEngine(base.PricingEngine):
    ...
    def __init__(self, probability: base.DefaultProbabilityTermStructure, recoveryRate: typing.SupportsFloat | typing.SupportsIndex, discountCurve: base.YieldTermStructure, includeSettlementDateFlows: bool | None = None) -> None:
        ...
        Constructs from term structures (handles created internally).
        """
class MidPointTrapezoidIntegral(base.Integrator):
    """
...
class MinBasketPayoff(base.BasketPayoff):
    ...
    def __init__(self, basePayoff: base.Payoff) -> None:
        ...
        Constructs with base payoff.
        """
class MixedInterpolationBehavior:
    """
    ...
    Members:
      ...
      SplitRanges
    """
    ShareRanges: typing.ClassVar[MixedInterpolationBehavior]  # value = <MixedInterpolationBehavior.ShareRanges: 0>
    SplitRanges: typing.ClassVar[MixedInterpolationBehavior]  # value = <MixedInterpolationBehavior.SplitRanges: 1>
    __members__: typing.ClassVar[dict[str, MixedInterpolationBehavior]]  # value = {'ShareRanges': <MixedInterpolationBehavior.ShareRanges: 0>, 'SplitRanges': <MixedInterpolationBehavior.SplitRanges: 1>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
    ...
    def value(self) -> int:
        ...
class MixedLinearCubicInterpolation(base.Interpolation):
    """
    Mixed linear/cubic interpolation between discrete points.
    """
    def __init__(self, x: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], y: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], n: typing.SupportsInt | typing.SupportsIndex, behavior: MixedInterpolationBehavior = ..., derivativeApprox: CubicDerivativeApprox = ..., monotonic: bool = False, leftCondition: CubicBoundaryCondition = ..., leftConditionValue: typing.SupportsFloat | typing.SupportsIndex = 0.0, rightCondition: CubicBoundaryCondition = ..., rightConditionValue: typing.SupportsFloat | typing.SupportsIndex = 0.0) -> None:
        """
...
class MixedLinearCubicNaturalSpline(MixedLinearCubicInterpolation):
    ...
    """
    def __init__(self, x: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], y: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], n: typing.SupportsInt | typing.SupportsIndex, behavior: MixedInterpolationBehavior = ...) -> None:
        """
        Constructs interpolation from x and y arrays.
        """
...
class MoreGreeks:
    ...
    def strikeSensitivity(self, arg0: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
class MultiCurve(base.Observer):
    """
    Manages a set of yield curves that form a dependency cycle.
    """
    @typing.overload
    def __init__(self, accuracy: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
        Constructs with a target accuracy for the bootstrap.
        """
    @typing.overload
    def __init__(self, optimizer: base.OptimizationMethod = None, endCriteria: EndCriteria = None) -> None:
        """
        Constructs with an optimization method and end criteria.
        """
    def addBootstrappedCurve(self, internalHandle: RelinkableYieldTermStructureHandle, curve: base.YieldTermStructure) -> YieldTermStructureHandle:
        """
        Adds a bootstrapped curve and returns an external handle.
        """
    def addNonBootstrappedCurve(self, internalHandle: RelinkableYieldTermStructureHandle, curve: base.YieldTermStructure) -> YieldTermStructureHandle:
        """
...
class MultiPath:
    ...
    def __init__(self, nAsset: typing.SupportsInt | typing.SupportsIndex, timeGrid: TimeGrid) -> None:
        ...
        """
    @typing.overload
    def __init__(self, paths: collections.abc.Sequence[Path]) -> None:
        """
    ...
    def pathSize(self) -> int:
        ...
        """
class MultiplicativePriceSeasonality(base.Seasonality):
    """
    ...
    def seasonalityBaseDate(self) -> Date:
        ...
        """
    def seasonalityFactor(self, date: Date) -> float:
        """
...
class NoArbSabrModel:
    ...
    """
    def __init__(self, expiryTime: typing.SupportsFloat | typing.SupportsIndex, forward: typing.SupportsFloat | typing.SupportsIndex, alpha: typing.SupportsFloat | typing.SupportsIndex, beta: typing.SupportsFloat | typing.SupportsIndex, nu: typing.SupportsFloat | typing.SupportsIndex, rho: typing.SupportsFloat | typing.SupportsIndex) -> None:
        """
    ...
    def beta(self) -> float:
        ...
    def density(self, strike: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
        Returns the probability density at the given strike.
        """
    def digitalOptionPrice(self, strike: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
    ...
    def numericalForward(self) -> float:
        ...
        """
    def optionPrice(self, strike: typing.SupportsFloat | typing.SupportsIndex) -> float:
        """
...
class NoArbSabrSmileSection(base.SmileSection):
    ...
    def __init__(self, timeToExpiry: typing.SupportsFloat | typing.SupportsIndex, forward: typing.SupportsFloat | typing.SupportsIndex, sabrParameters: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], shift: typing.SupportsFloat | typing.SupportsIndex = 0.0, volatilityType: VolatilityType = ...) -> None:
        ...
        """
    @typing.overload
    def __init__(self, expiryDate: Date, forward: typing.SupportsFloat | typing.SupportsIndex, sabrParameters: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], dayCounter: DayCounter = ..., shift: typing.SupportsFloat | typing.SupportsIndex = 0.0, volatilityType: VolatilityType = ...) -> None:
        """
...
class NonstandardSwap(Swap):
    ...
    """
    @typing.overload
    def __init__(self, fromVanilla: FixedVsFloatingSwap) -> None:
        """
    ...
    def type(self) -> SwapType:
        ...
        Returns the swap type.
        """
class NonstandardSwaption(base.Option):
    """
    Option to enter into a nonstandard swap.
    """
    @typing.overload
    def __init__(self, fromSwaption: Swaption) -> None:
        """
        Constructs from a standard swaption.
        """
    @typing.overload
    def __init__(self, swap: NonstandardSwap, exercise: Exercise, delivery: SettlementType = ..., settlementMethod: SettlementMethod = ...) -> None:
        """
...
class NthOrderDerivativeOp(FdmLinearOp):
    ...
    """
    def __init__(self, direction: typing.SupportsInt | typing.SupportsIndex, order: typing.SupportsInt | typing.SupportsIndex, nPoints: typing.SupportsInt | typing.SupportsIndex, mesher: FdmMesher) -> None:
        """
...
class Ordering:
    ...
    Members:
      ...
      Factors : Best-quality variates for the first factor.
    
      Steps : Best-quality variates for the largest steps.
    
      Diagonal : Diagonal schema balancing factors and steps.
    """
    Diagonal: typing.ClassVar[Ordering]  # value = <Ordering.Diagonal: 2>
    Factors: typing.ClassVar[Ordering]  # value = <Ordering.Factors: 0>
    Steps: typing.ClassVar[Ordering]  # value = <Ordering.Steps: 1>
    __members__: typing.ClassVar[dict[str, Ordering]]  # value = {'Factors': <Ordering.Factors: 0>, 'Steps': <Ordering.Steps: 1>, 'Diagonal': <Ordering.Diagonal: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
    ...
    def value(self) -> int:
        ...
class OrnsteinUhlenbeckProcess(base.StochasticProcess1D):
    """
...
class PartialBarrierRange:
    ...
    Members:
      ...
      Start : Monitor from start until cover event.
    
      EndB1 : Monitor from cover event to exercise; knock-out on any crossing.
    
      EndB2 : Monitor from cover event to exercise; immediate knock-out if wrong side.
    """
    EndB1: typing.ClassVar[PartialBarrierRange]  # value = <PartialBarrierRange.EndB1: 2>
    EndB2: typing.ClassVar[PartialBarrierRange]  # value = <PartialBarrierRange.EndB2: 3>
    Start: typing.ClassVar[PartialBarrierRange]  # value = <PartialBarrierRange.Start: 0>
    __members__: typing.ClassVar[dict[str, PartialBarrierRange]]  # value = {'Start': <PartialBarrierRange.Start: 0>, 'EndB1': <PartialBarrierRange.EndB1: 2>, 'EndB2': <PartialBarrierRange.EndB2: 3>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
    ...
    def value(self) -> int:
        ...
class PartialTimeBarrierOption(base.OneAssetOption):
    """
    Partial-time barrier option.
    """
    def __init__(self, barrierType: BarrierType, barrierRange: PartialBarrierRange, barrier: typing.SupportsFloat | typing.SupportsIndex, rebate: typing.SupportsFloat | typing.SupportsIndex, coverEventDate: Date, payoff: base.StrikedTypePayoff, exercise: Exercise) -> None:
        """
...
class Path:
    ...
    def __getitem__(self, i: typing.SupportsInt | typing.SupportsIndex) -> float:
        ...
        """
    def __init__(self, timeGrid: TimeGrid, values: Array = ...) -> None:
        """
...
class Period:
    ...
    def __neg__(self) -> Period:
        ...
    def __radd__(self, arg0: typing.Any) -> Date:
        ...
    def __repr__(self) -> str:
        ...
...
class PiecewiseBackwardFlatForward(base.YieldTermStructure):
    ...
    def times(self) -> list[float]:
        ...
        """
class PiecewiseBackwardFlatForwardGlobal(base.YieldTermStructure):
    """
    Piecewise yield curve using backward-flat forward-rate interpolation with global bootstrap.
    """
    @typing.overload
    def __init__(self, referenceDate: Date, instruments: collections.abc.Sequence[base.RateHelper], dayCounter: DayCounter, accuracy: typing.SupportsFloat | typing.SupportsIndex = ..., instrumentWeights: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex] = []) -> None:
        """
        Constructs with global bootstrap using default optimizer.
        """
    @typing.overload
    def __init__(self, referenceDate: Date, instruments: collections.abc.Sequence[base.RateHelper], dayCounter: DayCounter, optimizer: base.OptimizationMethod, endCriteria: EndCriteria = None, instrumentWeights: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex] = []) -> None:
        """
        Constructs with global bootstrap using a custom optimizer.
        """
    @typing.overload
    def __init__(self, referenceDate: Date, instruments: collections.abc.Sequence[base.RateHelper], dayCounter: DayCounter, additionalHelpers: collections.abc.Sequence[base.RateHelper], additionalDates: collections.abc.Callable[[], list[Date]], additionalPenalties: collections.abc.Callable[[], Array], accuracy: typing.SupportsFloat | typing.SupportsIndex = ..., instrumentWeights: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex] = []) -> None:
        """
        Constructs with global bootstrap, additional helpers, and penalty functions.
        """
    @typing.overload
    def __init__(self, settlementDays: typing.SupportsInt | typing.SupportsIndex, calendar: Calendar, instruments: collections.abc.Sequence[base.RateHelper], dayCounter: DayCounter, accuracy: typing.SupportsFloat | typing.SupportsIndex = ..., instrumentWeights: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex] = []) -> None:
        """
...
class PiecewiseLinearZero(base.YieldTermStructure):
    ...
    def times(self) -> list[float]:
        ...
        Returns the interpolation times.
        """
class PiecewiseLinearZeroGlobal(base.YieldTermStructure):
    """
...
class PiecewiseLogLinearDiscount(base.YieldTermStructure):
    ...
    def times(self) -> list[float]:
        ...
        Returns the interpolation times.
        """
class PiecewiseLogLinearDiscountGlobal(base.YieldTermStructure):
    """
...
class PiecewiseTimeDependentHestonModel(base.CalibratedModel):
    ...
    def v0(self) -> float:
        ...
        Returns initial variance.
        """
class PiecewiseYoYInflationCurve(base.YoYInflationTermStructure):
    """
    ...
    def times(self) -> list[float]:
        ...
        Returns the interpolation times.
        """
class PiecewiseZeroInflationCurve(base.ZeroInflationTermStructure):
    """
...
class QdFpTanhSinhIterationScheme(QdFpIterationScheme):
    ...
    def __init__(self, m: typing.SupportsInt | typing.SupportsIndex, n: typing.SupportsInt | typing.SupportsIndex, eps: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
        """
class QdPlusAmericanEngine(base.PricingEngine):
    """
    ...
    def __init__(self, process: GeneralizedBlackScholesProcess, interpolationPoints: typing.SupportsInt | typing.SupportsIndex = 8, solverType: QdPlusAmericanEngineSolverType = ..., eps: typing.SupportsFloat | typing.SupportsIndex = 1e-06, maxIter: typing.Any = None) -> None:
        ...
        """
class QdPlusAmericanEngineSolverType:
    """
    ...
    Members:
      ...
      SuperHalley
    """
    Brent: typing.ClassVar[QdPlusAmericanEngineSolverType]  # value = <QdPlusAmericanEngineSolverType.Brent: 0>
    Halley: typing.ClassVar[QdPlusAmericanEngineSolverType]  # value = <QdPlusAmericanEngineSolverType.Halley: 3>
    Newton: typing.ClassVar[QdPlusAmericanEngineSolverType]  # value = <QdPlusAmericanEngineSolverType.Newton: 1>
    Ridder: typing.ClassVar[QdPlusAmericanEngineSolverType]  # value = <QdPlusAmericanEngineSolverType.Ridder: 2>
    SuperHalley: typing.ClassVar[QdPlusAmericanEngineSolverType]  # value = <QdPlusAmericanEngineSolverType.SuperHalley: 4>
    __members__: typing.ClassVar[dict[str, QdPlusAmericanEngineSolverType]]  # value = {'Brent': <QdPlusAmericanEngineSolverType.Brent: 0>, 'Newton': <QdPlusAmericanEngineSolverType.Newton: 1>, 'Ridder': <QdPlusAmericanEngineSolverType.Ridder: 2>, 'Halley': <QdPlusAmericanEngineSolverType.Halley: 3>, 'SuperHalley': <QdPlusAmericanEngineSolverType.SuperHalley: 4>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
    ...
    def value(self) -> int:
        ...
class QuantoForwardVanillaEngine(base.PricingEngine):
    """
    Quanto forward-start European option engine.
    """
    @typing.overload
    def __init__(self, process: GeneralizedBlackScholesProcess, foreignRiskFreeRate: YieldTermStructureHandle, exchangeRateVolatility: BlackVolTermStructureHandle, correlation: QuoteHandle) -> None:
        ...
    @typing.overload
    def __init__(self, process: GeneralizedBlackScholesProcess, foreignRiskFreeRate: base.YieldTermStructure, exchangeRateVolatility: base.BlackVolTermStructure, correlation: base.Quote) -> None:
        """
        Constructs from shared_ptr objects (handles created internally).
        """
class QuantoForwardVanillaOption(ForwardVanillaOption):
    ...
    def qvega(self) -> float:
        ...
        Returns quanto vega.
        """
class QuantoTermStructure(base.YieldTermStructure):
    """
    ...
    def __init__(self, underlyingDividendTS: base.YieldTermStructure, riskFreeTS: base.YieldTermStructure, foreignRiskFreeTS: base.YieldTermStructure, underlyingBlackVolTS: base.BlackVolTermStructure, strike: typing.SupportsFloat | typing.SupportsIndex, exchRateBlackVolTS: base.BlackVolTermStructure, exchRateATMlevel: typing.SupportsFloat | typing.SupportsIndex, underlyingExchRateCorrelation: typing.SupportsFloat | typing.SupportsIndex) -> None:
        ...
        Constructs from shared_ptrs (handles created internally).
        """
class QuantoVanillaEngine(base.PricingEngine):
    """
    ...
    def __init__(self, process: GeneralizedBlackScholesProcess, foreignRiskFreeRate: base.YieldTermStructure, exchangeRateVolatility: base.BlackVolTermStructure, correlation: base.Quote) -> None:
        ...
        Constructs from shared_ptr objects (handles created internally).
        """
class QuantoVanillaOption(base.OneAssetOption):
    """
...
class RelinkableZeroInflationTermStructureHandle(ZeroInflationTermStructureHandle):
    ...
    def linkTo(self, ptr: typing.Any = None, registerAsObserver: bool = True) -> None:
        ...
        Links the handle to a new object instance. Notifies observers.
        """
class ReplicatingVarianceSwapEngine(base.PricingEngine):
    """
...
class SVD:
    ...
    def singularValues(self) -> Array:
        ...
        """
    def solveFor(self, b: Array) -> Array:
        """
...
class SampleMultiPath:
    ...
    def value(self) -> MultiPath:
        ...
        """
    @value.setter
    def value(self, arg0: MultiPath) -> None:
        ...
    @property
...
class SecondOrderMixedDerivativeOp(NinePointLinearOp):
    ...
    def __init__(self, d0: typing.SupportsInt | typing.SupportsIndex, d1: typing.SupportsInt | typing.SupportsIndex, mesher: FdmMesher) -> None:
        ...
        Constructs from two directions and a mesher.
        """
class SegmentIntegral(base.Integrator):
    """
...
class SimpleCashFlow(base.CashFlow):
    ...
    def __init__(self, amount: typing.SupportsFloat | typing.SupportsIndex, date: Date) -> None:
        ...
        """
class SimpleChooserOption(base.OneAssetOption):
    """
...
class SimpleQuote(base.Quote):
    ...
    def value(self) -> float:
        ...
        Returns the current value.
        """
class Simplex(base.OptimizationMethod):
    """
    ...
    def lambda_(self) -> float:
        ...
        """
class SimpsonIntegral(TrapezoidIntegral, base.Integrator):
    """
...
class Singapore(Calendar):
    ...
    def __init__(self, m: Singapore.Market = ...) -> None:
        ...
class SingleFactorBsmBasketEngine(base.PricingEngine):
    """
    Single-factor BSM basket option engine.
    """
    def __init__(self, processes: collections.abc.Sequence[GeneralizedBlackScholesProcess], xTol: typing.SupportsFloat | typing.SupportsIndex = 2.220446049250313e-12) -> None:
        """
        Constructs engine.
        """
...
class SobolBrownianBridgeRsg:
    ...
    def nextSequence(self) -> ...:
        ...
        Returns next sample sequence.
        """
class SobolBrownianGenerator(base.BrownianGenerator):
    """
    ...
    def __init__(self, factors: typing.SupportsInt | typing.SupportsIndex, steps: typing.SupportsInt | typing.SupportsIndex, ordering: Ordering, seed: typing.SupportsInt | typing.SupportsIndex = 0, directionIntegers: SobolRsg.DirectionIntegers = ...) -> None:
        ...
        """
class SobolBrownianGeneratorFactory(base.BrownianGeneratorFactory):
    """
...
class SobolRsg:
    ...
    class DirectionIntegers:
        ...
        Members:
          ...
          Kuo3
        """
        Jaeckel: typing.ClassVar[SobolRsg.DirectionIntegers]  # value = <DirectionIntegers.Jaeckel: 1>
        JoeKuoD5: typing.ClassVar[SobolRsg.DirectionIntegers]  # value = <DirectionIntegers.JoeKuoD5: 4>
        JoeKuoD6: typing.ClassVar[SobolRsg.DirectionIntegers]  # value = <DirectionIntegers.JoeKuoD6: 5>
        JoeKuoD7: typing.ClassVar[SobolRsg.DirectionIntegers]  # value = <DirectionIntegers.JoeKuoD7: 6>
        Kuo: typing.ClassVar[SobolRsg.DirectionIntegers]  # value = <DirectionIntegers.Kuo: 7>
        Kuo2: typing.ClassVar[SobolRsg.DirectionIntegers]  # value = <DirectionIntegers.Kuo2: 8>
        Kuo3: typing.ClassVar[SobolRsg.DirectionIntegers]  # value = <DirectionIntegers.Kuo3: 9>
        ...
        __members__: typing.ClassVar[dict[str, SobolRsg.DirectionIntegers]]  # value = {'Unit': <DirectionIntegers.Unit: 0>, 'Jaeckel': <DirectionIntegers.Jaeckel: 1>, 'SobolLevitan': <DirectionIntegers.SobolLevitan: 2>, 'SobolLevitanLemieux': <DirectionIntegers.SobolLevitanLemieux: 3>, 'JoeKuoD5': <DirectionIntegers.JoeKuoD5: 4>, 'JoeKuoD6': <DirectionIntegers.JoeKuoD6: 5>, 'JoeKuoD7': <DirectionIntegers.JoeKuoD7: 6>, 'Kuo': <DirectionIntegers.Kuo: 7>, 'Kuo2': <DirectionIntegers.Kuo2: 8>, 'Kuo3': <DirectionIntegers.Kuo3: 9>}
        def __eq__(self, other: typing.Any) -> bool:
            ...
        def __getstate__(self) -> int:
            ...
...
class Sofr(OvernightIndex):
    ...
    def __init__(self, forwardingTermStructure: ...) -> None:
        ...
        """
class SoftBarrierOption(base.OneAssetOption):
    """
    Soft barrier option (proportional knock-in/out over barrier range).
    """
    def __init__(self, barrierType: BarrierType, barrierLo: typing.SupportsFloat | typing.SupportsIndex, barrierHi: typing.SupportsFloat | typing.SupportsIndex, payoff: base.StrikedTypePayoff, exercise: Exercise) -> None:
        """
        Constructs a soft barrier option.
        """
    def impliedVolatility(self, price: typing.SupportsFloat | typing.SupportsIndex, process: GeneralizedBlackScholesProcess, accuracy: typing.SupportsFloat | typing.SupportsIndex = 0.0001, maxEvaluations: typing.SupportsInt | typing.SupportsIndex = 100, minVol: typing.SupportsFloat | typing.SupportsIndex = 1e-06, maxVol: typing.SupportsFloat | typing.SupportsIndex = 4.0) -> float:
        """
        Returns implied volatility.
        """
...
class SpreadFittingMethod(base.FittingMethod):
    ...
    def __init__(self, method: base.FittingMethod, discountCurve: typing.Any, minCutoffTime: typing.SupportsFloat | typing.SupportsIndex = 0.0, maxCutoffTime: typing.SupportsFloat | typing.SupportsIndex = 1.7976931348623157e+308) -> None:
        ...
        """
class SpreadedSwaptionVolatility(base.SwaptionVolatilityStructure):
    """
    Swaption volatility with an additive spread.
    """
    @typing.overload
    def __init__(self, baseVolHandle: SwaptionVolatilityStructureHandle, spreadHandle: QuoteHandle) -> None:
        """
        Constructs from swaption vol and spread handles.
        """
    @typing.overload
    def __init__(self, baseVol: base.SwaptionVolatilityStructure, spread: base.Quote) -> None:
        """
        Constructs from shared_ptrs (handles created internally).
        """
class SquareRootProcess(base.StochasticProcess1D):
    """
    ...
    def x0(self) -> float:
        ...
        Returns initial value.
        """
class SquareRootProcessRNDCalculator(base.RiskNeutralDensityCalculator):
    """
...
class Statistics:
    ...
    def weightSum(self) -> float:
        ...
        Returns the sum of data weights.
        """
class SteepestDescent(base.OptimizationMethod):
    """
...
class Taiwan(Calendar):
    ...
    def __init__(self, m: Taiwan.Market = ...) -> None:
        ...
class TanhSinhIntegral(base.Integrator):
    """
...
class TimeUnit:
    ...
    def value(self) -> int:
        ...
class TrapezoidIntegral(base.Integrator):
    """
    ...
    def __init__(self, accuracy: typing.SupportsFloat | typing.SupportsIndex, maxIterations: typing.SupportsInt | typing.SupportsIndex) -> None:
        ...
        Constructs with target accuracy and maximum iterations.
        """
class TreeCallableFixedRateBondEngine(base.PricingEngine):
    """
    ...
    def __init__(self, model: base.ShortRateModel, timeSteps: typing.SupportsInt | typing.SupportsIndex, termStructure: YieldTermStructureHandle) -> None:
        ...
        """
    @typing.overload
    def __init__(self, model: base.ShortRateModel, timeGrid: TimeGrid) -> None:
        """
...
class TreeCallableZeroCouponBondEngine(TreeCallableFixedRateBondEngine):
    ...
    def __init__(self, model: base.ShortRateModel, timeSteps: typing.SupportsInt | typing.SupportsIndex, termStructure: base.YieldTermStructure) -> None:
        ...
        Constructs tree engine (handle created internally).
        """
class TreeCapFloorEngine(base.PricingEngine):
    """
...
class TripleBandLinearOp(FdmLinearOp):
    ...
    def __init__(self, direction: typing.SupportsInt | typing.SupportsIndex, mesher: FdmMesher) -> None:
        ...
        """
    @typing.overload
    def add(self, m: TripleBandLinearOp) -> TripleBandLinearOp:
        """
        Adds another triple-band operator.
        """
    @typing.overload
    def add(self, u: Array) -> TripleBandLinearOp:
        """
    ...
    def apply(self, r: Array) -> Array:
        ...
        Applies the operator to an array.
        """
    def axpyb(self, a: Array, x: TripleBandLinearOp, y: TripleBandLinearOp, b: Array) -> None:
        """
    ...
    def mult(self, u: Array) -> TripleBandLinearOp:
        ...
        Left-multiplies by a diagonal matrix.
        """
    def multR(self, u: Array) -> TripleBandLinearOp:
        """
...
class TurnbullWakemanAsianEngine(base.PricingEngine):
    ...
    def __init__(self, process: GeneralizedBlackScholesProcess) -> None:
        ...
        """
class TwoAssetBarrierOption(base.Option):
    """
    Barrier option on two assets.
    """
    def __init__(self, barrierType: BarrierType, barrier: typing.SupportsFloat | typing.SupportsIndex, payoff: base.StrikedTypePayoff, exercise: Exercise) -> None:
        """
    ...
    def isExpired(self) -> bool:
        ...
        """
class TwoAssetCorrelationOption(base.MultiAssetOption):
    """
...
class Ukraine(Calendar):
    ...
    def __init__(self, m: Ukraine.Market = ...) -> None:
        ...
class UltimateForwardTermStructure(base.YieldTermStructure):
    """
...
class UniformRandomSequenceGenerator:
    ...
    def lastSequence(self) -> ...:
        ...
        Returns the last generated sequence.
        """
    def nextInt32Sequence(self) -> list[int]:
        """
...
class VanillaSwap(FixedVsFloatingSwap):
    ...
    def __init__(self, type: SwapType, nominal: typing.SupportsFloat | typing.SupportsIndex, fixedSchedule: Schedule, fixedRate: typing.SupportsFloat | typing.SupportsIndex, fixedDayCount: DayCounter, floatSchedule: Schedule, iborIndex: IborIndex, spread: typing.SupportsFloat | typing.SupportsIndex, floatingDayCount: DayCounter, paymentConvention: pyquantlib._pyquantlib.BusinessDayConvention | None = None, useIndexedCoupons: bool | None = None) -> None:
        ...
        """
class VarianceGammaEngine(base.PricingEngine):
    """
...
class VarianceGammaModel(base.CalibratedModel):
    ...
    def theta(self) -> float:
        ...
        Returns theta.
        """
class VarianceGammaProcess(base.StochasticProcess1D):
    """
    ...
    def theta(self) -> float:
        ...
        """
class VarianceSwap(base.Instrument):
    """
...
class WeekendsOnly(Calendar):
    ...
    def __init__(self) -> None:
        ...
class WriterExtensibleOption(base.OneAssetOption):
    """
    Writer-extensible option.
    """
    def __init__(self, payoff1: PlainVanillaPayoff, exercise1: Exercise, payoff2: PlainVanillaPayoff, exercise2: Exercise) -> None:
        ...
    def exercise2(self) -> Exercise:
        """
        Returns the second exercise.
        """
    def payoff2(self) -> base.Payoff:
        """
...
class YYAUCPI(YoYInflationIndex):
    ...
    def __init__(self, frequency: Frequency, revised: bool, h: ...) -> None:
        ...
        """
    @typing.overload
    def __init__(self, frequency: Frequency, revised: bool, yoyInflationTermStructure: ...) -> None:
        """
...
class YearOnYearInflationSwap(Swap):
    ...
    def type(self) -> SwapType:
        ...
        Returns the swap type.
        """
    def yoyDayCount(self) -> DayCounter:
        """
        Returns the YoY-leg day counter.
        """
    def yoyInflationIndex(self) -> YoYInflationIndex:
        """
        Returns the YoY inflation index.
        """
    def yoyLeg(self) -> list[base.CashFlow]:
        """
        Returns the YoY leg.
        """
    def yoyLegNPV(self) -> float:
        ...
        """
    def yoySchedule(self) -> Schedule:
        """
        Returns the YoY schedule.
        """
class YearOnYearInflationSwapHelper(base.RelativeDateYoYInflationHelper):
    """
    Year-on-year inflation swap bootstrap helper.
    """
    @typing.overload
    def __init__(self, quote: QuoteHandle, swapObsLag: Period, maturity: Date, calendar: Calendar, paymentConvention: BusinessDayConvention, dayCounter: DayCounter, yoyInflationIndex: YoYInflationIndex, interpolation: CPI.InterpolationType, nominalTermStructure: YieldTermStructureHandle) -> None:
        """
        Constructs from quote handle.
        """
    @typing.overload
    def __init__(self, quote: base.Quote, swapObsLag: Period, maturity: Date, calendar: Calendar, paymentConvention: BusinessDayConvention, dayCounter: DayCounter, yoyInflationIndex: YoYInflationIndex, interpolation: CPI.InterpolationType, nominalTermStructure: YieldTermStructureHandle) -> None:
        """
...
class YieldTermStructureHandle:
    ...
    def get(self) -> base.YieldTermStructure:
        ...
        Returns the underlying shared_ptr. Raises error if empty.
        """
class YoYInflationBachelierCapFloorEngine(base.PricingEngine):
    """
    Bachelier (normal) engine for YoY inflation cap/floor.
    """
    @typing.overload
    def __init__(self, index: YoYInflationIndex, volatility: YoYOptionletVolatilitySurfaceHandle, nominalTermStructure: YieldTermStructureHandle) -> None:
        """
        Constructs a Bachelier YoY inflation cap/floor engine.
        """
    @typing.overload
    def __init__(self, index: YoYInflationIndex, volatility: base.YoYOptionletVolatilitySurface, nominalTermStructure: base.YieldTermStructure) -> None:
        """
        Constructs with both handles created internally.
        """
class YoYInflationBlackCapFloorEngine(base.PricingEngine):
    """
    ...
    def __init__(self, index: YoYInflationIndex, volatility: YoYOptionletVolatilitySurfaceHandle, nominalTermStructure: YieldTermStructureHandle) -> None:
        ...
        """
    @typing.overload
    def __init__(self, index: YoYInflationIndex, volatility: base.YoYOptionletVolatilitySurface, nominalTermStructure: YieldTermStructureHandle) -> None:
        """
        Constructs with vol surface (handle created internally).
        """
    @typing.overload
    def __init__(self, index: YoYInflationIndex, volatility: YoYOptionletVolatilitySurfaceHandle, nominalTermStructure: base.YieldTermStructure) -> None:
        """
...
class YoYInflationCap(YoYInflationCapFloor):
    ...
    def __init__(self, yoyLeg: collections.abc.Sequence[base.CashFlow], exerciseRates: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex]) -> None:
        ...
        """
class YoYInflationCapFloor(base.Instrument):
    """
    ...
    def isExpired(self) -> bool:
        ...
        Returns True if expired.
        """
    def lastYoYInflationCoupon(self) -> YoYInflationCoupon:
        """
...
class YoYInflationCapFloorType:
    ...
    Members:
      ...
      Collar
    """
    Cap: typing.ClassVar[YoYInflationCapFloorType]  # value = <YoYInflationCapFloorType.Cap: 0>
    Collar: typing.ClassVar[YoYInflationCapFloorType]  # value = <YoYInflationCapFloorType.Collar: 2>
    Floor: typing.ClassVar[YoYInflationCapFloorType]  # value = <YoYInflationCapFloorType.Floor: 1>
    __members__: typing.ClassVar[dict[str, YoYInflationCapFloorType]]  # value = {'Cap': <YoYInflationCapFloorType.Cap: 0>, 'Floor': <YoYInflationCapFloorType.Floor: 1>, 'Collar': <YoYInflationCapFloorType.Collar: 2>}
    def __eq__(self, other: typing.Any) -> bool:
        ...
    def __getstate__(self) -> int:
        ...
...
class YoYInflationCollar(YoYInflationCapFloor):
    ...
    def __init__(self, yoyLeg: collections.abc.Sequence[base.CashFlow], capRates: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex], floorRates: collections.abc.Sequence[typing.SupportsFloat | typing.SupportsIndex]) -> None:
        ...
        """
class YoYInflationCoupon(base.InflationCoupon):
    """
    ...
    def yoyIndex(self) -> ...:
        ...
        Returns the YoY inflation index.
        """
class YoYInflationCouponPricer(base.InflationCouponPricer):
    """
    ...
    def nominalTermStructure(self) -> ...:
        ...
        """
    def setCapletVolatility(self, capletVol: ...) -> None:
        """
        Sets the caplet volatility handle.
        """
class YoYInflationCurve(base.YoYInflationTermStructure):
    """
...
class YoYInflationTermStructureHandle:
    ...
    def get(self) -> base.YoYInflationTermStructure:
        ...
        Returns the underlying shared_ptr. Raises error if empty.
        """
class YoYInflationUnitDisplacedBlackCapFloorEngine(base.PricingEngine):
    """
...
class YoYOptionletVolatilitySurfaceHandle:
    ...
    def __bool__(self) -> bool:
        ...
        Checks if the handle is non-empty.
        """
    def __eq__(self, arg0: YoYOptionletVolatilitySurfaceHandle) -> bool:
        ...
    @typing.overload
    def __init__(self) -> None:
        """
    ...
    def __init__(self, ptr: typing.Any, registerAsObserver: bool = True) -> None:
        ...
        Creates a handle linked to the given object.
        """
    def __lt__(self, arg0: YoYOptionletVolatilitySurfaceHandle) -> bool:
        ...
    def __ne__(self, arg0: YoYOptionletVolatilitySurfaceHandle) -> bool:
        ...
    def asObservable(self) -> Observable:
        """
        Converts to Observable for observer registration.
        """
    def currentLink(self) -> base.YoYOptionletVolatilitySurface:
        """
        Returns the shared_ptr to the current object link.
        """
    def empty(self) -> bool:
        ...
        Returns true if the handle is empty.
        """
    def get(self) -> base.YoYOptionletVolatilitySurface:
        """
        Returns the underlying shared_ptr. Raises error if empty.
        """
...
class ZeroCouponInflationSwap(Swap):
    ...
    def __init__(self, type: SwapType, nominal: typing.SupportsFloat | typing.SupportsIndex, startDate: Date, maturity: Date, fixCalendar: Calendar, fixConvention: BusinessDayConvention, dayCounter: DayCounter, fixedRate: typing.SupportsFloat | typing.SupportsIndex, infIndex: ZeroInflationIndex, observationLag: Period, observationInterpolation: CPI.InterpolationType, adjustInfObsDates: bool = False, infCalendar: typing.Any = None, infConvention: typing.Any = None) -> None:
        ...
        """
    def adjustObservationDates(self) -> bool:
        """
    ...
    def fairRate(self) -> float:
        ...
        Returns the fair fixed rate.
        """
    def fixedCalendar(self) -> Calendar:
        """
        Returns the fixed-leg calendar.
        """
    def fixedConvention(self) -> BusinessDayConvention:
        """
        Returns the fixed-leg business day convention.
        """
    def fixedLeg(self) -> list[base.CashFlow]:
    ...
    def fixedRate(self) -> float:
        ...
        Returns the fixed rate.
        """
    def inflationCalendar(self) -> Calendar:
        """
        Returns the inflation calendar.
        """
    def inflationConvention(self) -> BusinessDayConvention:
        """
        Returns the inflation business day convention.
        """
    def inflationIndex(self) -> ZeroInflationIndex:
        """
        Returns the inflation index.
        """
    def inflationLeg(self) -> list[base.CashFlow]:
        """
    ...
    def type(self) -> SwapType:
        ...
        Returns the swap type.
        """
class ZeroCouponInflationSwapHelper(base.RelativeDateZeroInflationHelper):
    """
    Zero-coupon inflation swap bootstrap helper.
    """
    @typing.overload
    def __init__(self, quote: QuoteHandle, swapObsLag: Period, maturity: Date, calendar: Calendar, paymentConvention: BusinessDayConvention, dayCounter: DayCounter, zeroInflationIndex: ZeroInflationIndex, observationInterpolation: CPI.InterpolationType) -> None:
        """
        Constructs from quote handle.
        """
    @typing.overload
    def __init__(self, quote: base.Quote, swapObsLag: Period, maturity: Date, calendar: Calendar, paymentConvention: BusinessDayConvention, dayCounter: DayCounter, zeroInflationIndex: ZeroInflationIndex, observationInterpolation: CPI.InterpolationType) -> None:
        """
        Constructs from quote (handle created internally).
        """
    @typing.overload
...
class ZeroCurve(base.YieldTermStructure):
    ...
    def zeroRates(self) -> list[float]:
        ...
        Returns the zero rates.
        """
class ZeroInflationCashFlow(base.CashFlow):
    """
    ...
    def zeroInflationIndex(self) -> ...:
        ...
        """
class ZeroInflationCurve(base.ZeroInflationTermStructure):
    """
...
class yoyInflationLeg:
    ...
    """
    def __init__(self, schedule: Schedule, calendar: Calendar, index: ..., observationLag: Period, interpolation: ...) -> None:
        """
...
def Abs(array: Array) -> Array:
    ...
    """
def BinomialBarrierEngine(process: GeneralizedBlackScholesProcess, treeType: str, timeSteps: typing.SupportsInt | typing.SupportsIndex, maxTimeSteps: typing.SupportsInt | typing.SupportsIndex = 0, discretization: str = 'default') -> base.PricingEngine:
    """
...
def Log(array: Array) -> Array:
    ...
    """
def MCAmericanBasketEngine(process: StochasticProcessArray, rngType: str = 'pseudorandom', timeSteps: typing.Any = None, timeStepsPerYear: typing.Any = None, brownianBridge: bool = False, antitheticVariate: bool = False, requiredSamples: typing.Any = None, requiredTolerance: typing.Any = None, maxSamples: typing.Any = None, seed: typing.SupportsInt | typing.SupportsIndex = 0, calibrationSamples: typing.Any = None, polynomialOrder: typing.SupportsInt | typing.SupportsIndex = 2) -> base.PricingEngine:
    """
...
def MCAmericanEngine(process: GeneralizedBlackScholesProcess, rngType: str = 'pseudorandom', timeSteps: typing.Any = None, timeStepsPerYear: typing.Any = None, antitheticVariate: bool = False, controlVariate: bool = False, requiredSamples: typing.Any = None, requiredTolerance: typing.Any = None, maxSamples: typing.Any = None, seed: typing.SupportsInt | typing.SupportsIndex = 0, polynomialOrder: typing.SupportsInt | typing.SupportsIndex = 2, polynomialType: PolynomialType = ..., calibrationSamples: typing.SupportsInt | typing.SupportsIndex = 2048) -> base.PricingEngine:
    ...
    """
def MCBarrierEngine(process: GeneralizedBlackScholesProcess, rngType: str = 'pseudorandom', timeSteps: typing.Any = None, timeStepsPerYear: typing.Any = None, brownianBridge: bool = False, antitheticVariate: bool = False, requiredSamples: typing.Any = None, requiredTolerance: typing.Any = None, maxSamples: typing.Any = None, isBiased: bool = False, seed: typing.SupportsInt | typing.SupportsIndex = 0) -> base.PricingEngine:
    """
    Monte Carlo barrier option pricing engine.
    
    Uses Brownian-bridge correction for the barrier by default.
    Set isBiased=True for the simpler (biased) path pricer.
    """
...
def MCDiscreteArithmeticAPEngine(process: GeneralizedBlackScholesProcess, rngType: str = 'pseudorandom', brownianBridge: bool = True, antitheticVariate: bool = False, controlVariate: bool = False, requiredSamples: typing.Any = None, requiredTolerance: typing.Any = None, maxSamples: typing.Any = None, seed: typing.SupportsInt | typing.SupportsIndex = 0) -> base.PricingEngine:
    ...
    """
def MCDiscreteArithmeticAPHestonEngine(process: HestonProcess, rngType: str = 'pseudorandom', antitheticVariate: bool = False, controlVariate: bool = False, requiredSamples: typing.Any = None, requiredTolerance: typing.Any = None, maxSamples: typing.Any = None, seed: typing.SupportsInt | typing.SupportsIndex = 0, timeSteps: typing.Any = None, timeStepsPerYear: typing.Any = None) -> base.PricingEngine:
    """
    Monte Carlo discrete arithmetic average price Asian engine (Heston).
    """
def MCDiscreteArithmeticASEngine(process: GeneralizedBlackScholesProcess, rngType: str = 'pseudorandom', brownianBridge: bool = True, antitheticVariate: bool = False, requiredSamples: typing.Any = None, requiredTolerance: typing.Any = None, maxSamples: typing.Any = None, seed: typing.SupportsInt | typing.SupportsIndex = 0) -> base.PricingEngine:
    """
    Monte Carlo discrete arithmetic average strike Asian engine.
    """
def MCDiscreteGeometricAPEngine(process: GeneralizedBlackScholesProcess, rngType: str = 'pseudorandom', brownianBridge: bool = True, antitheticVariate: bool = False, requiredSamples: typing.Any = None, requiredTolerance: typing.Any = None, maxSamples: typing.Any = None, seed: typing.SupportsInt | typing.SupportsIndex = 0) -> base.PricingEngine:
    """
    Monte Carlo discrete geometric average price Asian engine.
    """
def MCDiscreteGeometricAPHestonEngine(process: HestonProcess, rngType: str = 'pseudorandom', antitheticVariate: bool = False, requiredSamples: typing.Any = None, requiredTolerance: typing.Any = None, maxSamples: typing.Any = None, seed: typing.SupportsInt | typing.SupportsIndex = 0, timeSteps: typing.Any = None, timeStepsPerYear: typing.Any = None) -> base.PricingEngine:
    """
    Monte Carlo discrete geometric average price Asian engine (Heston).
    """
def MCDoubleBarrierEngine(process: GeneralizedBlackScholesProcess, rngType: str = 'pseudorandom', timeSteps: typing.Any = None, timeStepsPerYear: typing.Any = None, brownianBridge: bool = False, antitheticVariate: bool = False, requiredSamples: typing.Any = None, requiredTolerance: typing.Any = None, maxSamples: typing.Any = None, seed: typing.SupportsInt | typing.SupportsIndex = 0) -> base.PricingEngine:
    """
...
def setCouponPricer(leg: collections.abc.Sequence[base.CashFlow], pricer: base.FloatingRateCouponPricer) -> None:
    ...
    """
@typing.overload
def setCouponPricer(leg: collections.abc.Sequence[base.CashFlow], pricer: base.InflationCouponPricer) -> None:
    """
...
def sinkingNotionals(bondLength: Period, frequency: Frequency, couponRate: typing.SupportsFloat | typing.SupportsIndex, initialNotional: typing.SupportsFloat | typing.SupportsIndex) -> list[float]:
    ...
    """
def sinkingSchedule(startDate: Date, bondLength: Period, frequency: Frequency, paymentCalendar: Calendar) -> Schedule:
    """
...
def years(period: Period) -> float:
    ...
    """
AdjustDigitals: MarkovFunctionalAdjustments  # value = <MarkovFunctionalAdjustments.AdjustDigitals: 1>
AdjustNone: MarkovFunctionalAdjustments  # value = <MarkovFunctionalAdjustments.AdjustNone: 0>
AdjustYts: MarkovFunctionalAdjustments  # value = <MarkovFunctionalAdjustments.AdjustYts: 2>
...
CustomSmile: MarkovFunctionalAdjustments  # value = <MarkovFunctionalAdjustments.CustomSmile: 512>
...
Diagonal: Ordering  # value = <Ordering.Diagonal: 2>
Douglas: FdmSchemeType  # value = <FdmSchemeType.Douglas: 1>
EPSILON: float = 2.220446049250313e-16
EndB1: PartialBarrierRange  # value = <PartialBarrierRange.EndB1: 2>
EndB2: PartialBarrierRange  # value = <PartialBarrierRange.EndB2: 3>
...
ExtrapolatePayoffFlat: MarkovFunctionalAdjustments  # value = <MarkovFunctionalAdjustments.ExtrapolatePayoffFlat: 4>
Factors: Ordering  # value = <Ordering.Factors: 0>
...
KahaleInterpolation: MarkovFunctionalAdjustments  # value = <MarkovFunctionalAdjustments.KahaleInterpolation: 64>
KahaleSmile: MarkovFunctionalAdjustments  # value = <MarkovFunctionalAdjustments.KahaleSmile: 16>
...
NoPayoffExtrapolation: MarkovFunctionalAdjustments  # value = <MarkovFunctionalAdjustments.NoPayoffExtrapolation: 8>
...
QL_VERSION: str = '1.41'
QL_VERSION_HEX: int = 21037296
Quarterly: Frequency  # value = <Frequency.Quarterly: 4>
SabrSmile: MarkovFunctionalAdjustments  # value = <MarkovFunctionalAdjustments.SabrSmile: 256>
...
ShareRanges: MixedInterpolationBehavior  # value = <MixedInterpolationBehavior.ShareRanges: 0>
Simple: Compounding  # value = <Compounding.Simple: 0>
SimpleThenCompounded: Compounding  # value = <Compounding.SimpleThenCompounded: 3>
SmileDeleteArbitragePoints: MarkovFunctionalAdjustments  # value = <MarkovFunctionalAdjustments.SmileDeleteArbitragePoints: 128>
SmileExponentialExtrapolation: MarkovFunctionalAdjustments  # value = <MarkovFunctionalAdjustments.SmileExponentialExtrapolation: 32>
...
SplitRanges: MixedInterpolationBehavior  # value = <MixedInterpolationBehavior.SplitRanges: 1>
Spot: CashDividendModel  # value = <CashDividendModel.Spot: 0>
Start: PartialBarrierRange  # value = <PartialBarrierRange.Start: 0>
Steps: Ordering  # value = <Ordering.Steps: 1>
