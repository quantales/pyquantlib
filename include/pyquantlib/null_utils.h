...
/**
 * @brief Converts a Python object to a QuantLib type, handling Null values.
 * 
...
/**
 * @brief Checks if a Python object represents a Null value.
 */
template <typename T>
