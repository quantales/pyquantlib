...
namespace ql_methods {
    ...
    void fdmlinearopiterator(py::module_&);
    void fdmlinearoplayout(py::module_&);
    void fdm1dmesher(py::module_&);
    void uniform1dmesher(py::module_&);
    void concentrating1dmesher(py::module_&);
    void predefined1dmesher(py::module_&);
    void fdmquantohelper(py::module_&);
    void fdmblackscholesmesher(py::module_&);
    void fdmhestonvariancemesher(py::module_&);
    void fdmcev1dmesher(py::module_&);
    void fdmsimpleprocess1dmesher(py::module_&);
    void exponentialjump1dmesher(py::module_&);
    void glued1dmesher(py::module_&);
    void fdmmesher(py::module_&);
    void fdmmeshercomposite(py::module_&);
    void boundarycondition(py::module_&);
    void fdmdirichletboundary(py::module_&);
    void fdmdiscountdirichletboundary(py::module_&);
    void fdmtimedepdirichletboundary(py::module_&);
    void fdmlinearop(py::module_&);
    void fdmlinearopcomposite(py::module_&);
    void triplebandlinearop(py::module_&);
    void firstderivativeop(py::module_&);
    void secondderivativeop(py::module_&);
    void ninepointlinearop(py::module_&);
    void secondordermixedderivativeop(py::module_&);
    void fdmblackscholesop(py::module_&);
    void fdmblackscholesfwdop(py::module_&);
    void fdm2dblackscholesop(py::module_&);
    void fdmhestonop(py::module_&);
    void fdmhestonfwdop(py::module_&);
    void fdmhestonhullwhiteop(py::module_&);
    void fdmbatesop(py::module_&);
    void fdmhullwhiteop(py::module_&);
    void fdmg2op(py::module_&);
    void fdmcevop(py::module_&);
    void fdmsabrop(py::module_&);
    void fdmlocalvolfwdop(py::module_&);
    void fdmornsteinuhlenbeckop(py::module_&);
    void nthorderderivativeop(py::module_&);
    void expliciteulerscheme(py::module_&);
    void impliciteulerscheme(py::module_&);
    void cranknicolsonscheme(py::module_&);
    void douglasscheme(py::module_&);
    void craigsneydscheme(py::module_&);
    void hundsdorferscheme(py::module_&);
    void modifiedcraigsneydscheme(py::module_&);
    void methodoflinesscheme(py::module_&);
    void stepcondition(py::module_&);
    void fdminnervaluecalculator(py::module_&);
    void fdmsnapshotcondition(py::module_&);
    void fdmamericanstepcondition(py::module_&);
    void fdmbermudanstepcondition(py::module_&);
    void fdmarithmeticaveragecondition(py::module_&);
    void fdmsimpleswingcondition(py::module_&);
    void fdmdividendhandler(py::module_&);
    void fdmstepconditioncomposite(py::module_&);
    void fdmsolverdesc(py::module_&);
    void fdm1dimsolver(py::module_&);
    void fdm2dimsolver(py::module_&);
    void fdm3dimsolver(py::module_&);
    void fdmblackscholessolver(py::module_&);
    void fdmhestonsolver(py::module_&);
    void fdmhullwhitesolver(py::module_&);
    void fdmg2solver(py::module_&);
    void fdm2dblackscholessolver(py::module_&);
    void fdmbatessolver(py::module_&);
    void riskneutraldensitycalculator(py::module_&);
    void bsmrndcalculator(py::module_&);
    void gbsmrndcalculator(py::module_&);
    void hestonrndcalculator(py::module_&);
    void cevrndcalculator(py::module_&);
    void squarerootprocessrndcalculator(py::module_&);
    void localvolrndcalculator(py::module_&);
